...
.method public isNonLatinLanguageWithBlankKey(I)Z
    ...
    const/high16 v0, 0x7275

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x6267

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x756b

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x6b6b

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x6d6b

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x6172

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x6661

    if-eq p1, v0, :cond_0

    const/high16 v0, 0x7572
