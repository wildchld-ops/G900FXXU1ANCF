...
.method private filteringLanguageID(I)I
    ...
    :sswitch_1
    const/high16 v0, 0x6672

    goto :goto_0

    :sswitch_2
    const/high16 v0, 0x6573

    goto :goto_0

    :sswitch_3
    const/high16 v0, 0x7074

    goto :goto_0

    :sswitch_4
    const/high16 v0, 0x6865
...
.method private onKeyDownContinue(ILandroid/view/KeyEvent;I)Z
    ...
    :goto_0
    iget-object v4, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mHwKeyManager:Lcom/diotek/ime/framework/input/hw/HwKeyManager;

    invoke-virtual {p2}, Landroid/view/KeyEvent;->isShiftPressed()Z

    move-result v5

    invoke-virtual {v4, p1, v5, v1}, Lcom/diotek/ime/framework/input/hw/HwKeyManager;->getCharacter(IZZ)S
    ...
    invoke-virtual {p0, v0, v4}, Lcom/diotek/ime/framework/input/AbstractInputController;->onKey(I[I)V

    iget-object v2, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mChineseCandidates:Ljava/util/ArrayList;
    ...
    invoke-interface {v2}, Lcom/diotek/ime/framework/common/InputManager;->isHwPhonepad()Z
...
.method public onKey(I[I)V
    ...
    iget-boolean v2, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mIsAcuteAccentState:Z
    ...
    :cond_5
    :goto_2
    iget-boolean v9, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mIsAcuteAccentState:Z

    if-eq v2, v9, :cond_1e

    iget-object v9, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mInputManager:Lcom/diotek/ime/framework/common/InputManager;

    iget-boolean v10, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mIsAcuteAccentState:Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {v8}, Lcom/diotek/ime/framework/common/InputManager;->isHWKeyboardOpen()Z
    ...
    :cond_0
    const-string v8, "com.sec.android.app.popupcalculator"
    ...
    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mInputModeManager:Lcom/diotek/ime/framework/inputmode/InputModeManager;

    invoke-virtual {v8}, Lcom/diotek/ime/framework/inputmode/InputModeManager;->isLatinSoftFuncKey()Z
    ...
    invoke-interface {v8}, Lcom/diotek/ime/framework/common/ShiftStateController;->getShiftMomentaryState()Z
    ...
    invoke-interface {v8}, Lcom/diotek/ime/framework/common/ShiftStateController;->toggleShiftState()V

    :cond_8
    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mShiftStateController:Lcom/diotek/ime/framework/common/ShiftStateController;

    invoke-interface {v8, v6}, Lcom/diotek/ime/framework/common/ShiftStateController;->setShiftPressedState(Z)V

    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mShiftStateController:Lcom/diotek/ime/framework/common/ShiftStateController;

    invoke-interface {v8, v6}, Lcom/diotek/ime/framework/common/ShiftStateController;->setShiftMomentaryState(Z)V

    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mShiftStateController:Lcom/diotek/ime/framework/common/ShiftStateController;

    invoke-interface {v8, v11}, Lcom/diotek/ime/framework/common/ShiftStateController;->setPressedShiftKeyCode(I)V

    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mShiftStateController:Lcom/diotek/ime/framework/common/ShiftStateController;

    invoke-interface {v8, v6}, Lcom/diotek/ime/framework/common/ShiftStateController;->setShiftHoldOn(Z)V
    ...
    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mRepository:Lcom/diotek/ime/framework/repository/Repository;
    ...
    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mHwKeyManager:Lcom/diotek/ime/framework/input/hw/HwKeyManager;

    invoke-virtual {v8, v2, v6, v7}, Lcom/diotek/ime/framework/input/hw/HwKeyManager;->getCharacter(IZZ)S
    ...
    invoke-virtual {v8}, Lcom/diotek/ime/framework/input/hw/HwKeyManager;->isEmptyKey()Z
    ...
    invoke-virtual {v8, p1, v9, v4}, Lcom/diotek/ime/framework/input/hw/HwKeyManager;->getCharacter(IZZ)S
    ...
    invoke-interface {v8}, Lcom/diotek/ime/framework/common/InputManager;->isDeviceHasHardwareKeypad()Z
    ...
    :cond_14
    iget-object v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mCurrentInputModule:Lcom/diotek/ime/framework/input/InputModule;

    new-array v9, v7, [I

    aput v12, v9, v6

    invoke-interface {v8, v12, v9}, Lcom/diotek/ime/framework/input/InputModule;->onCharacterKey(I[I)V
    ...
    invoke-interface {v6, v8}, Lcom/diotek/ime/framework/common/ShiftStateController;->setCapsLockState(Z)V

    goto/16 :goto_0

    :sswitch_5
    iput-boolean v6, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mIsHwKeyboardCtrlRightPressed:Z
    ...
    iget-boolean v8, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mIsHwKeyboardCtrlRightPressed:Z
...
.method public updateAcuteAccentState(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/diotek/ime/framework/engine/InputEngineManager;->updateAcuteAccentState(Z)V

    iput-boolean p1, p0, Lcom/diotek/ime/framework/input/AbstractInputController;->mIsAcuteAccentState:Z
