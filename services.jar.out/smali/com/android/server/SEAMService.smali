...
.method private createDrsHandlerThreadIfNeeded()V
    ...
    const-string v1, "thread is started"
...
.method public setMacPermission(Landroid/app/enterprise/ContextInfo;[BZ)I
    ...
    sget-object v3, Lcom/android/server/SEAMService;->MAC_POLICY_FILE:Ljava/io/File;

    invoke-static {v3}, Lcom/android/server/pm/SELinuxMMAC;->readInstallPolicy(Ljava/io/File;)Z
...
.method public setSEAppContexts(Landroid/app/enterprise/ContextInfo;[BZ)I
    ...
    const-string v4, "setSEAppContexts: files copied unsuccesfully"
...
.method public setSELinuxPolicy(Landroid/app/enterprise/ContextInfo;[BZ)I
    ...
    const-string v4, "setSELinuxPolicy: files copied unsuccesfully"
