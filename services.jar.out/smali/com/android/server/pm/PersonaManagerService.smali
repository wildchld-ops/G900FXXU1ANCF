...
.method static synthetic access$2500(Lcom/android/server/pm/PersonaManagerService;)Landroid/util/SparseBooleanArray;
    .locals 1
...
.method static synthetic access$2600(Lcom/android/server/pm/PersonaManagerService;I)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$2700(Lcom/android/server/pm/PersonaManagerService;ILjava/util/Set;)V
    .locals 0
...
.method private getUninstallablePackagesForRemovePersona(I)Ljava/util/Set;
    ...
    const-string v13, "getUninstallablePackagesForRemovePersona : is called for"
    ...
    const-string v12, "getUninstallablePackagesForRemovePersona no personaInfo for this persona"
    ...
    :cond_1
    invoke-virtual {v9}, Landroid/content/pm/PersonaInfo;->getParentId()I
    ...
    const-string v13, "getUninstallablePackagesForRemovePersona : parentUserId "
    ...
    const-string v13, "Collect packages started for  : personaid "
    ...
    invoke-direct {p0, v2, v4}, Lcom/android/server/pm/PersonaManagerService;->collectInstalledPackages(ILjava/util/Set;)V
    ...
    const-string v13, "Collect packages igonored for  : personaid "
    ...
    const-string v13, "Collect packages started for  : parentUserId "
    ...
    invoke-direct {p0, v6, v4}, Lcom/android/server/pm/PersonaManagerService;->collectInstalledPackages(ILjava/util/Set;)V
    ...
    const-string v13, "Collect packages started for removing : personaId "
    ...
    invoke-direct {p0, p1, v10}, Lcom/android/server/pm/PersonaManagerService;->collectInstalledPackages(ILjava/util/Set;)V
    ...
    const-string v13, "otherUsersPackages size -"
    ...
    const-string v13, "personaPackages size -"
    ...
    const-string v13, "packagesToBeUnInstall size -"
    ...
    const-string v13, "Pkg to be uninstalled is -"
...
.method private readUser(II)Landroid/content/pm/PersonaInfo;
    ...
    invoke-virtual/range {v45 .. v45}, Landroid/util/AtomicFile;->openRead()Ljava/io/FileInputStream;
    ...
    const-string v47, "Unable to read user "
...
.method private writeUserLocked(Landroid/content/pm/PersonaInfo;)V
    ...
    const-string/jumbo v6, "writeUserLocked called"
    ...
    iget v7, p1, Landroid/content/pm/PersonaInfo;->serialNumber:I
    ...
    iget v7, p1, Landroid/content/pm/PersonaInfo;->flags:I
    ...
    iget-wide v7, p1, Landroid/content/pm/PersonaInfo;->creationTime:J
    ...
    iget-wide v7, p1, Landroid/content/pm/PersonaInfo;->lastLoggedInTime:J
    ...
    const-string v6, "lastLoggedOut"

    iget-wide v7, p1, Landroid/content/pm/PersonaInfo;->lastLoggedOutTime:J
    ...
    iget-object v5, p1, Landroid/content/pm/PersonaInfo;->iconPath:Ljava/lang/String;
    ...
    iget-object v7, p1, Landroid/content/pm/PersonaInfo;->iconPath:Ljava/lang/String;

    invoke-interface {v3, v5, v6, v7}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    :cond_0
    iget-boolean v5, p1, Landroid/content/pm/PersonaInfo;->partial:Z
    ...
    :cond_1
    iget-boolean v5, p1, Landroid/content/pm/PersonaInfo;->removePersona:Z

    if-eqz v5, :cond_2

    const/4 v5, 0x0

    const-string v6, "removePersona"
    ...
    :cond_2
    iget-boolean v5, p1, Landroid/content/pm/PersonaInfo;->isUserManaged:Z

    if-eqz v5, :cond_3

    const/4 v5, 0x0

    const-string v6, "isUserManaged"
    ...
    :cond_3
    iget-boolean v5, p1, Landroid/content/pm/PersonaInfo;->resetPassword:Z
    ...
    iget v7, p1, Landroid/content/pm/PersonaInfo;->oldState:I
    ...
    iget v7, p1, Landroid/content/pm/PersonaInfo;->state:I
    ...
    const-string/jumbo v7, "writeUserLocked state is "
    ...
    const-string v7, "superlocked"

    iget-boolean v5, p1, Landroid/content/pm/PersonaInfo;->isSuperLocked:Z
    ...
    const-string v7, "fsMounted"

    iget-boolean v5, p1, Landroid/content/pm/PersonaInfo;->isFsMounted:Z
    ...
    const-string v6, "personahandlername"
    ...
    const-string v6, "personahandlerpackage"
    ...
    const-string v6, "setupapklocation"
    ...
    const-string v6, "handlerapklocation"
    ...
    const-string v6, "adminpackagename"
    ...
    const-string v6, "encryptedId"

    iget-object v7, p1, Landroid/content/pm/PersonaInfo;->encryptedId:Ljava/lang/String;
    ...
    iget-object v5, p1, Landroid/content/pm/PersonaInfo;->name:Ljava/lang/String;
...
.method public startRemovingPersona(I)I
    ...
    const-string v0, "startRemovingPersona"

    invoke-static {v0}, Lcom/android/server/pm/PersonaManagerService;->checkCallerPermissionFor(Ljava/lang/String;)I

    const-string v0, "PersonaManagerService"

    const-string v1, "startRemovingPersona is called.."
...
.method public stopAndRemovePersona(IZ)I
    ...
    const-string v2, "stopAndRemovePersona"

    invoke-static {v2}, Lcom/android/server/pm/PersonaManagerService;->checkCallerPermissionFor(Ljava/lang/String;)I

    const-string v2, "PersonaManagerService"

    const-string v3, "stopAndRemovePersona is called.."
...
.method public stopPersona(I)I
    ...
    const-string v0, "stopPersona"

    invoke-static {v0}, Lcom/android/server/pm/PersonaManagerService;->checkCallerPermissionFor(Ljava/lang/String;)I

    const-string v0, "PersonaManagerService"

    const-string v1, "stopPersona is called.."
...
.method public switchPersona(I)Z
    ...
    const-string v8, "switching to persona "
...
.method public switchPersonaAndLaunch(ILandroid/content/Intent;)Z
    ...
    const-string v6, "switchPersonaAndLaunch"
