...
.method public extension_setStartNavigatingModes(ILandroid/net/ConnectivityManager;ZZ)I
    ...
    const-string v6, "startNavigating SW test : isAgpsSwitchMode : "
    ...
    const-string v5, "startNavigating : agps on only for hom network info.isRoaming() == true "
    ...
    const-string v5, "startNavigating : agps on only for hom network info.isRoaming() == false have not record. MS_BASED "
    ...
    const-string v5, "startNavigating : agps on only for hom network PS error  STANDALONE"
    ...
    const-string v6, "startNavigating : //agpson for all network isAgpsSwitchMode : "
    ...
    const-string v6, "startNavigating : //agps off isAgpsSwitchMode : "
