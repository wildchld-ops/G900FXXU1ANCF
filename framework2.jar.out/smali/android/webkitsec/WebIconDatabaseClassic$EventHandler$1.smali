...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #calls: Landroid/webkitsec/WebIconDatabaseClassic;->nativeOpen(Ljava/lang/String;)V
    invoke-static {v2}, Landroid/webkitsec/WebIconDatabaseClassic;->access$100(Ljava/lang/String;)V

    goto :goto_0

    :pswitch_1
    #calls: Landroid/webkitsec/WebIconDatabaseClassic;->nativeClose()V
    invoke-static {}, Landroid/webkitsec/WebIconDatabaseClassic;->access$200()V

    goto :goto_0

    :pswitch_2
    #calls: Landroid/webkitsec/WebIconDatabaseClassic;->nativeRemoveAllIcons()V
    ...
    #calls: Landroid/webkitsec/WebIconDatabaseClassic$EventHandler;->requestIconAndSendResult(Ljava/lang/String;Landroid/webkitsec/WebIconDatabase$IconListener;)V
    ...
    #calls: Landroid/webkitsec/WebIconDatabaseClassic$EventHandler;->bulkRequestIcons(Landroid/os/Message;)V
    ...
    #calls: Landroid/webkitsec/WebIconDatabaseClassic;->nativeRetainIconForPageUrl(Ljava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebIconDatabaseClassic;->nativeReleaseIconForPageUrl(Ljava/lang/String;)V
