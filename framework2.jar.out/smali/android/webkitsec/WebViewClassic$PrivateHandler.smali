...
.method public clearPreviousHitTest()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->setHitTestResult(Landroid/webkitsec/WebViewCore$WebKitHitTest;)V
...
.method public dispatchUiEvent(Landroid/view/MotionEvent;II)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->onHandleUiEvent(Landroid/view/MotionEvent;II)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->pinScrollBy(IIZI)Z
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->scrollLayerTo(II)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->contentScrollTo(IIZ)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->playTouchSound()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->notifySingleTapReleased()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->nativeCreate(ILjava/lang/String;Z)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->nativeSetPauseDrawing(IZ)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->setAppType()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->enabledTouchPerformancePatch(Z)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->updateTextSelectionFromMessage(IILandroid/webkitsec/WebViewCore$TextSelectionData;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->updateTextSelectionStartEndFromMessage(IILandroid/webkitsec/WebViewCore$TextInputData;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->hideSoftKeyboard()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->displaySoftKeyboardWithDelay()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->viewInvalidate(IIII)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->showSelectActionWindow()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->displaySoftKeyboard(Z)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->inFullScreenMode()Z
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->dismissFullScreenMode()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->getVisibleTitleHeightImpl()I
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->setTouchHighlightRects(Landroid/webkitsec/WebViewCore$WebKitHitTest;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->copyToClipboard(Ljava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->nativeMapLayerRect(IILandroid/graphics/Rect;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->relocateAutoCompletePopup()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->nativeScrollRectOnScreen(ILandroid/graphics/Rect;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->setupWebkitSelect()Z
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->resetCaretTimer()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->showPasteWindow()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->scrollEditWithCursor()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->scrollDraggedSelectionHandleIntoView()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->updateSelectionInfo(Landroid/webkitsec/WebViewCore$SelectionCopiedData;)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->isSelectionChanged(Landroid/webkitsec/WebViewCore$SelectionCopiedData;Landroid/webkitsec/WebViewCore$SelectionCopiedData;)Z
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->notifySelectionChanged()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->isWebViewSelectionChanged(Landroid/webkitsec/WebViewCore$SelectionCopiedData;Landroid/webkitsec/WebViewCore$SelectionCopiedData;)Z
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->updateImageSelectedRect()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->displayColorPicker()V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->displayDateTimePickers(Ljava/lang/String;Ljava/lang/String;)V
