...
.method private setSharedTimer(J)V
    ...
    invoke-virtual {p0, v3}, Landroid/webkitsec/JWebCoreJavaBridge;->obtainMessage(I)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0, p1, p2}, Landroid/webkitsec/JWebCoreJavaBridge;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private signalServiceFuncPtrQueue()V
    ...
    invoke-virtual {p0, v1}, Landroid/webkitsec/JWebCoreJavaBridge;->obtainMessage(I)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/webkitsec/JWebCoreJavaBridge;->sendMessage(Landroid/os/Message;)Z
...
.method private stopSharedTimer()V
    ...
    invoke-virtual {p0, v0}, Landroid/webkitsec/JWebCoreJavaBridge;->removeMessages(I)V
