...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCloseIdleConnections(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeRevealSelection(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->webkitDraw()V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeScrollFocusedTextInput(IFI)V
    ...
    #calls: Landroid/webkitsec/WebViewCore$EventHub;->sendMessage(Landroid/os/Message;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeupdateTextSelection(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->loadUrl(Ljava/lang/String;Ljava/util/Map;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeRegisterURLSchemeAsLocal(ILjava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeContentInvalidateAll(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->key(Landroid/view/KeyEvent;IZ)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->keyPress(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->viewSizeChanged(Landroid/webkitsec/WebViewClassic$ViewSizeData;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetScrollOffset(IZII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectedText(I)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetInputTextBounds(ILandroid/graphics/Rect;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCheckSpellingOfWordAtPosition(III)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeUnmarkWord(ILjava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetGlobalBounds(IIIII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeRecalcWidthAndForceLayout(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->restoreState(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativePause(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeResume(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->clearCache(Z)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeFreeMemory(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSimulateDelKeyForCount(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetTextAroundCursor(IIZ)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeDeleteSurroundingText(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectionOffset(I)Landroid/graphics/Point;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectionOffsetImage(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetBodyText(I)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetBodyHTML(I)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetBodyEmpty(I)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeContentSelectionType(I)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetCursorRect(IZ)Landroid/graphics/Rect;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeExecCommand(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeUpdateTextSelectionStartAndEnd(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCanUndo(I)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCanRedo(I)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeisTouchedOutside(III)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeUndoRedoStateReset(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCopyAndSaveImage(ILjava/lang/String;)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->webkitSelectionControlDraw(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetFullMarkupData(I)Landroid/webkitsec/WebHTMLMarkupData;
    ...
    :goto_4
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetEditable(IZ)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetSelectionEditable(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeMoveSingleCursorHandler(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetComposingRegion(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetPageZoom(IF)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetSelectionNone(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectionNone(I)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetComposingSelectionNone(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeRestorePreviousSelectionController(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSaveSelectionController(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeUpdateIMSelection(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCheckSelectionAtBoundry(I)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeInsertContent(ILjava/lang/String;IZLjava/util/Vector;)Landroid/graphics/Point;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCheckSelectedClosestWord(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetStateInRichlyEditableText(I)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeinsertImageContent(ILjava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeresizeImage(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativegetCurrentFontSize(I)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativegetCurrentFontValue(I)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetImageSize(III)Landroid/graphics/Rect;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectedImageRect(I)Landroid/graphics/Rect;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->webkitActionBarDraw()V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCheckEndOfWordAtPosition(III)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectedImageUri(I)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSelectBWStartAndEnd(IIIII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetCursorFromRangeSelectionController(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeIsAtBoundary(III)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeDropTheDraggedText(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeResetSelectionController(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetSelectedHTMLText(I)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeReplaceTextfieldText(IIILjava/lang/String;III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->passToJs(IILjava/lang/String;IIZZZZ)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSaveDocumentState(I)V
    ...
    :goto_7
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetFocusControllerActive(IZ)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeMoveMouse(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->performHitTest(IIIZ)Landroid/webkitsec/WebViewCore$WebKitHitTest;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeDeleteSelection(IIII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetSelection(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeModifySelection(III)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSendListBoxChoices(I[ZI)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSendListBoxChoice(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetBackgroundColor(II)V
    ...
    :goto_a
    #calls: Landroid/webkitsec/WebViewCore;->nativeDumpDomTree(IZ)V
    ...
    :goto_b
    #calls: Landroid/webkitsec/WebViewCore;->nativeDumpRenderTree(IZ)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetJsFlags(ILjava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->saveWebArchive(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGeolocationPermissionsProvide(ILjava/lang/String;ZZ)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeProvideVisitedHistory(I[Ljava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeFullScreenPluginHidden(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativePluginSurfaceReady(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeNotifyAnimationStarted(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->setUseMockGeolocation()V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->setUseMockDeviceOrientation()V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeAutoFillForm(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeScrollLayer(IILandroid/graphics/Rect;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeDeleteText(IIIII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeGetText(IIIII)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeCopyMoveSelection(IIIIZZFI)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeWebTextSelectionAll(IIIII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSelectClosestWord(IIIFZ)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeClearTextSelectionEx(III)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->webkitSelectionControlBT()V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeInsertText(ILjava/lang/String;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSelectText(IIII)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSelectWordAt(III)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSelectAll(I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeFindAll(ILjava/lang/String;)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeFindNext(IZ)I
    ...
    #calls: Landroid/webkitsec/WebViewCore;->applyreadability(ILjava/lang/String;)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->loadinitialJs(ILjava/lang/String;)Ljava/lang/String;
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSetInitialFocus(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->saveViewState(Ljava/io/OutputStream;Landroid/webkitsec/ValueCallback;)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeSendColorPickerChoice(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeNotificationPermissionsProvide(Ljava/lang/String;Z)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeNotificationResponseback(Ljava/lang/String;I)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeNotificationIDback(II)V
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeMoveFocusToNext(I)Z
    ...
    #calls: Landroid/webkitsec/WebViewCore;->nativeMoveFocusToPrevious(I)Z
