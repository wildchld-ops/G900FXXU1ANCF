...
.method private saveScreenshotInWorkerThread(Ljava/lang/Runnable;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/systemui/screenshot/SaveImageInBackgroundTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method takeScreenshot(Ljava/lang/Runnable;ZZI)V
    ...
    :cond_3
    iget-object v1, p0, Lcom/android/systemui/screenshot/GlobalScreenshot;->mSpenGestureManager:Lcom/samsung/android/smartclip/SpenGestureManager;

    if-eqz v1, :cond_4

    iget-object v1, p0, Lcom/android/systemui/screenshot/GlobalScreenshot;->mSpenGestureManager:Lcom/samsung/android/smartclip/SpenGestureManager;

    invoke-virtual {v1}, Lcom/samsung/android/smartclip/SpenGestureManager;->getSmartClipDataFromCurrentScreen()Lcom/samsung/android/smartclip/SmartClipDataRepositoryImpl;

    move-result-object v1

    iput-object v1, p0, Lcom/android/systemui/screenshot/GlobalScreenshot;->mRepository:Lcom/samsung/android/smartclip/SmartClipDataRepositoryImpl;
