...
.method public constructor <init>(Landroid/content/Context;Lcom/android/settings/ToggleImageView;)V
    ...
    iput-object p2, p0, Lcom/android/settings/AirplaneModeSwitchEnabler;->mToggleImageView:Lcom/android/settings/ToggleImageView;
...
.method static synthetic access$200(Lcom/android/settings/AirplaneModeSwitchEnabler;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/settings/AirplaneModeSwitchEnabler;->onToggleChanged()V
...
.method static synthetic access$500(Lcom/android/settings/AirplaneModeSwitchEnabler;)Lcom/android/settings/ToggleImageView;
    .locals 1
...
.method private onToggleChanged()V
    ...
    iget-object v7, p0, Lcom/android/settings/AirplaneModeSwitchEnabler;->mToggleImageView:Lcom/android/settings/ToggleImageView;

    invoke-virtual {v7}, Lcom/android/settings/ToggleImageView;->getToggleState()Z

    move-result v0

    iget-object v7, p0, Lcom/android/settings/AirplaneModeSwitchEnabler;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/android/settings/AirplaneModeSwitchEnabler;->isAirplaneModeOn(Landroid/content/Context;)Z
    ...
    iget-object v7, p0, Lcom/android/settings/AirplaneModeSwitchEnabler;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    invoke-direct {v7, p0, v6}, Lcom/android/settings/AirplaneModeSwitchEnabler$4;-><init>(Lcom/android/settings/AirplaneModeSwitchEnabler;Z)V
    ...
    new-instance v8, Lcom/android/settings/AirplaneModeSwitchEnabler$5;

    invoke-direct {v8, p0}, Lcom/android/settings/AirplaneModeSwitchEnabler$5;-><init>(Lcom/android/settings/AirplaneModeSwitchEnabler;)V
    ...
    new-instance v7, Lcom/android/settings/AirplaneModeSwitchEnabler$6;

    invoke-direct {v7, p0}, Lcom/android/settings/AirplaneModeSwitchEnabler$6;-><init>(Lcom/android/settings/AirplaneModeSwitchEnabler;)V
