...
.method public InitShortcutList(Ljava/lang/String;)Z
    ...
    iget-object v6, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mCr:Landroid/content/ContentResolver;

    const-string v7, "lock_screen_shortcut_number_of_apps"

    invoke-static {v6, v7, v4}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v6

    iput v6, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mNumOfSavedShortcut:I

    const-string v6, "LockScreenShortcutListManager"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "mNumOfSavedShortcut : "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mNumOfSavedShortcut:I
    ...
    const-string v7, "lock_screen_shortcut_app_list"
    ...
    iget-object v6, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mShortcutList:Ljava/util/ArrayList;
    ...
    const-string v6, "mShortcutList is not initialized"
    ...
    :cond_0
    const-string v6, "com.samsung.android.intent.action.PRIVATE_MODE_ON"
    ...
    iget-object v4, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mAppList:Ljava/util/List;

    invoke-direct {p0, v4}, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->SmakeList(Ljava/util/List;)Ljava/util/List;

    move-result-object v2

    iget v4, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mNumOfSavedShortcut:I

    invoke-direct {p0, v2, v4, v3}, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->getAvailableShortcutList(Ljava/util/List;ILjava/lang/String;)Ljava/util/ArrayList;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mShortcutList:Ljava/util/ArrayList;

    :goto_1
    iget-object v4, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mShortcutList:Ljava/util/ArrayList;

    invoke-virtual {v4}, Ljava/util/ArrayList;->size()I

    move-result v4

    iget v6, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mNumOfSavedShortcut:I

    if-ge v4, v6, :cond_1

    const-string v4, "LockScreenShortcutListManager"

    const-string v6, "mShortcutList.size() < mNumOfSavedShortcut)"
    ...
    iput v4, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mNumOfSavedShortcut:I
    ...
    :cond_2
    const-string v6, "com.samsung.android.intent.action.PRIVATE_MODE_OFF"
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->NmakeList(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mPm:Landroid/content/pm/PackageManager;
    ...
    iput-object v6, p0, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->mAppList:Ljava/util/List;
    ...
    invoke-direct {p0, v1, v4, v3}, Lcom/android/settings/lockscreenshortcut/LockScreenShortcutListManager;->getAvailableShortcutList(Ljava/util/List;ILjava/lang/String;)Ljava/util/ArrayList;
...
.method public clearShortcutList()V
    .locals 1
