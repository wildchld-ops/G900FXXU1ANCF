...
.method public initPref()V
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mDummyDate:Ljava/util/Calendar;

    const-string v2, "dormant_mode_help"

    invoke-virtual {p0, v2}, Lcom/android/settings/dormantmode/DormantmodeSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v2

    check-cast v2, Lcom/android/settings/UnclickablePreference;

    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mHelpPref:Lcom/android/settings/UnclickablePreference;
    ...
    iget-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mHelpPref:Lcom/android/settings/UnclickablePreference;

    const v5, 0x7f0914ad

    invoke-virtual {v2, v5}, Lcom/android/settings/UnclickablePreference;->setTitle(I)V
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mIncomingCallPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mNotificationsPref:Landroid/preference/CheckBoxPreference;
    ...
    const-string v2, "disable_alarm_and_timer"
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAlarmandTimePref:Landroid/preference/CheckBoxPreference;
    ...
    const-string v2, "disable_led_indicator"
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mLedIndicatorPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAlwaysPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedContactsPref:Landroid/preference/ListPreference;
    ...
    const-string v6, "dormant_allow_list"
    ...
    invoke-direct {p0, v2}, Lcom/android/settings/dormantmode/DormantmodeSettings;->setAllowListsummery(Ljava/lang/String;)V
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedListPref:Landroid/preference/Preference;
    ...
    const-string v2, "set_time_category"
    ...
    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mSetTimPref:Landroid/preference/PreferenceCategory;
    ...
    new-instance v2, Lcom/android/settings/dormantmode/DormantmodeSettings$3;

    invoke-virtual {p0}, Lcom/android/settings/dormantmode/DormantmodeSettings;->getActivity()Landroid/app/Activity;

    move-result-object v5

    invoke-direct {v2, p0, v5}, Lcom/android/settings/dormantmode/DormantmodeSettings$3;-><init>(Lcom/android/settings/dormantmode/DormantmodeSettings;Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mSetTimeDialogPref:Landroid/preference/Preference;
    ...
    iget-object v2, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mSetTimPref:Landroid/preference/PreferenceCategory;
    ...
    const-string v2, "allowed_contacts_category"
