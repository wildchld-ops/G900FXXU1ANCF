...
.method private executeMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/phone/PhoneGlobals;->registerRcsObserver(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/phone/PhoneGlobals;->unRegisterRcsObserver(I)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/phone/PhoneGlobals;->onNewIncomingRcsSession(Ljava/lang/String;)V
