...
.method private showProgressIndication(II)V
    ...
    invoke-direct {p0}, Lcom/android/phone/ErrorDialogActivity;->dismissProgressIndication()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/phone/ErrorDialogActivity;->requestWindowFeature(I)Z
    ...
    const-string v8, "show_missing_voicemail"
    ...
    invoke-virtual {v7, p0}, Lcom/android/phone/PhoneGlobals;->setErrorDialogActivityInstance(Lcom/android/phone/ErrorDialogActivity;)V

    invoke-virtual {p0}, Lcom/android/phone/ErrorDialogActivity;->getIntent()Landroid/content/Intent;

    move-result-object v7

    const-string v8, "vt_fail_try_voicecall_number"
    ...
    const-string v8, "error_message_id"

    invoke-virtual {v7, v8, v10}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I

    move-result v1

    invoke-direct {p0, v1, v6}, Lcom/android/phone/ErrorDialogActivity;->showTryVoicecallDialog(ILjava/lang/String;)V
    ...
    const-string v8, "call_status_code"
    ...
    const-string v8, "progress_indication_type"

    invoke-virtual {v7, v8}, Landroid/content/Intent;->getSerializableExtra(Ljava/lang/String;)Ljava/io/Serializable;

    move-result-object v4

    check-cast v4, Lcom/android/phone/Constants$ProgressIndicationType;
    ...
    invoke-direct {p0, v4}, Lcom/android/phone/ErrorDialogActivity;->updateProgressIndication(Lcom/android/phone/Constants$ProgressIndicationType;)V

    goto :goto_0

    :cond_4
    sget-object v7, Lcom/android/phone/ErrorDialogActivity;->TAG:Ljava/lang/String;

    const-string v8, "ErrorDialogActivity called with no error type extra."
