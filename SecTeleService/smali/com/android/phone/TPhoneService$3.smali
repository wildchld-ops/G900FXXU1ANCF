...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->mHandlerToString(I)Ljava/lang/String;
    invoke-static {v9}, Lcom/android/phone/TPhoneService;->access$500(I)Ljava/lang/String;
    ...
    invoke-static {v7, v8}, Lcom/android/phone/Log;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendPhoneState()V
    ...
    #calls: Lcom/android/phone/TPhoneService;->log(Ljava/lang/String;Z)V
    invoke-static {v7, v8, v11}, Lcom/android/phone/TPhoneService;->access$800(Lcom/android/phone/TPhoneService;Ljava/lang/String;Z)V

    iget-object v7, p0, Lcom/android/phone/TPhoneService$3;->this$0:Lcom/android/phone/TPhoneService;

    #getter for: Lcom/android/phone/TPhoneService;->mPrevFgCallState:Lcom/android/internal/telephony/Call$State;
    invoke-static {v7}, Lcom/android/phone/TPhoneService;->access$900(Lcom/android/phone/TPhoneService;)Lcom/android/internal/telephony/Call$State;
    ...
    #calls: Lcom/android/phone/TPhoneService;->log(Ljava/lang/String;)V
    invoke-static {v7, v8}, Lcom/android/phone/TPhoneService;->access$400(Lcom/android/phone/TPhoneService;Ljava/lang/String;)V

    iget-object v7, p0, Lcom/android/phone/TPhoneService$3;->this$0:Lcom/android/phone/TPhoneService;

    #getter for: Lcom/android/phone/TPhoneService;->apps:Lcom/android/phone/PhoneGlobals;
    invoke-static {v7}, Lcom/android/phone/TPhoneService;->access$1000(Lcom/android/phone/TPhoneService;)Lcom/android/phone/PhoneGlobals;

    move-result-object v7

    invoke-virtual {v7, v10}, Lcom/android/phone/PhoneGlobals;->displayTPhone(I)V

    :cond_3
    iget-object v7, p0, Lcom/android/phone/TPhoneService$3;->this$0:Lcom/android/phone/TPhoneService;

    #setter for: Lcom/android/phone/TPhoneService;->mPrevFgCallState:Lcom/android/internal/telephony/Call$State;
    invoke-static {v7, v2}, Lcom/android/phone/TPhoneService;->access$902(Lcom/android/phone/TPhoneService;Lcom/android/internal/telephony/Call$State;)Lcom/android/internal/telephony/Call$State;
    ...
    invoke-static {v7, v13}, Lcom/android/phone/TPhoneService;->access$1102(Lcom/android/phone/TPhoneService;Lcom/skt/prod/phone/TCall;)Lcom/skt/prod/phone/TCall;

    iget-object v7, p0, Lcom/android/phone/TPhoneService$3;->this$0:Lcom/android/phone/TPhoneService;

    #setter for: Lcom/android/phone/TPhoneService;->mPendingDisplayTPhone:Z
    invoke-static {v7, v10}, Lcom/android/phone/TPhoneService;->access$1202(Lcom/android/phone/TPhoneService;Z)Z
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendNewIncomingCall(Landroid/os/AsyncResult;)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->onDisconnect(Landroid/os/AsyncResult;)V
    invoke-static {v8, v7}, Lcom/android/phone/TPhoneService;->access$1400(Lcom/android/phone/TPhoneService;Landroid/os/AsyncResult;)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendDisconnectCall(Landroid/os/AsyncResult;)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendPostOnDialChars(Landroid/os/AsyncResult;C)V
    invoke-static {v8, v7, v9}, Lcom/android/phone/TPhoneService;->access$1600(Lcom/android/phone/TPhoneService;Landroid/os/AsyncResult;C)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendSuppServiceFailed(Landroid/os/AsyncResult;)V
    invoke-static {v8, v7}, Lcom/android/phone/TPhoneService;->access$1700(Lcom/android/phone/TPhoneService;Landroid/os/AsyncResult;)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->handleModifyCallRequest(Lcom/android/internal/telephony/Connection;)V
    invoke-static {v8, v7}, Lcom/android/phone/TPhoneService;->access$1800(Lcom/android/phone/TPhoneService;Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-static {v8, v7}, Lcom/android/phone/TPhoneService;->access$1902(Lcom/android/phone/TPhoneService;Lcom/android/internal/telephony/Connection;)Lcom/android/internal/telephony/Connection;
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendVideoCallResult(I)V
    invoke-static {v7, v12}, Lcom/android/phone/TPhoneService;->access$2000(Lcom/android/phone/TPhoneService;I)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendVideoCallResult(I)V
    invoke-static {v7, v11}, Lcom/android/phone/TPhoneService;->access$2000(Lcom/android/phone/TPhoneService;I)V
    ...
    #calls: Lcom/android/phone/TPhoneService;->sendSuppServiceNotification(Landroid/os/AsyncResult;)V
    invoke-static {v8, v7}, Lcom/android/phone/TPhoneService;->access$2100(Lcom/android/phone/TPhoneService;Landroid/os/AsyncResult;)V
