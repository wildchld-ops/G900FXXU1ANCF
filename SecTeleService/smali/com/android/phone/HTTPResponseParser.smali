...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/phone/HTTPResponseParser;->mStatusCode:I

    iput v0, p0, Lcom/android/phone/HTTPResponseParser;->mContentLength:I

    iput-object v1, p0, Lcom/android/phone/HTTPResponseParser;->mContentCharSet:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/phone/HTTPResponseParser;->mDownloadPath:Ljava/lang/String;
...
.method public parseEntity()Z
    ...
    iget-object v4, p0, Lcom/android/phone/HTTPResponseParser;->mDownloadPath:Ljava/lang/String;

    invoke-virtual {p0, v1, v4}, Lcom/android/phone/HTTPResponseParser;->convertIsToFile(Ljava/io/InputStream;Ljava/lang/String;)Z
    ...
    :cond_8
    const-string v5, "Free memory space is not enough"

    invoke-static {v5}, Lcom/android/phone/HTTPResponseParser;->englog(Ljava/lang/String;)V
    ...
    iput-object v4, p0, Lcom/android/phone/HTTPResponseParser;->mContents:Ljava/lang/String;

    goto :goto_1
.end method

.method public parsing(Lorg/apache/http/HttpResponse;)Z
    .locals 3
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/android/phone/HTTPResponseParser;->parseEntity()Z
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
