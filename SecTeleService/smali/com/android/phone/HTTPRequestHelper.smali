...
.method public handleResponse(Lorg/apache/http/HttpResponse;)V
    ...
    iget-object v4, p0, Lcom/android/phone/HTTPRequestHelper;->mHandler:Landroid/os/Handler;
    ...
    iget-object v5, p0, Lcom/android/phone/HTTPRequestHelper;->mUrl:Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/android/phone/CallMessageConstants$RequestType;->name()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/phone/HTTPRequestHelper;->mReqType:Lcom/android/phone/CallMessageConstants$RequestType;

    sget-object v5, Lcom/android/phone/CallMessageConstants$RequestType;->DOWNLOAD_CONTENT:Lcom/android/phone/CallMessageConstants$RequestType;

    if-ne v4, v5, :cond_2

    new-instance v3, Lcom/android/phone/HTTPResponseParser;

    iget-object v4, p0, Lcom/android/phone/HTTPRequestHelper;->mDownloadPath:Ljava/lang/String;

    invoke-direct {v3, v4}, Lcom/android/phone/HTTPResponseParser;-><init>(Ljava/lang/String;)V

    :goto_0
    if-eqz v3, :cond_3

    invoke-virtual {v3, p1}, Lcom/android/phone/HTTPResponseParser;->parsing(Lorg/apache/http/HttpResponse;)Z

    move-result v4

    if-eqz v4, :cond_3

    invoke-virtual {v3}, Lcom/android/phone/HTTPResponseParser;->dump()V

    invoke-virtual {v3}, Lcom/android/phone/HTTPResponseParser;->isHTMLContents()Z
    ...
    invoke-direct {v0, v4}, Lcom/android/phone/HTMLElement;-><init>(Ljava/lang/String;)V

    invoke-virtual {v3}, Lcom/android/phone/HTTPResponseParser;->getContents()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v4}, Lcom/android/phone/HTMLElement;->htmlParsing(Ljava/lang/String;)Z
    ...
    iget-object v5, v0, Lcom/android/phone/HTMLElement;->Data:Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    iget-object v4, p0, Lcom/android/phone/HTTPRequestHelper;->runningThread:Ljava/lang/Thread;
    ...
    const-string v4, "thread interrupted block send message"

    invoke-static {v4}, Lcom/android/phone/HTTPRequestHelper;->englog(Ljava/lang/String;)V
    ...
    invoke-direct {v3}, Lcom/android/phone/HTTPResponseParser;-><init>()V

    goto :goto_0

    :cond_3
    const-string v4, "handleResponse : HttpResponse is null, HTTP error occurred"
    ...
    const-string v6, "Local err1"

    invoke-direct {p0, v5, v6}, Lcom/android/phone/HTTPRequestHelper;->convertToJSONString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
