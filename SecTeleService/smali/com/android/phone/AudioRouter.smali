...
.method public onBluetoothIndicationChange(ZLcom/android/phone/BluetoothManager;)V
    ...
    const-string v0, "onBluetoothIndicationChange VideoCall : Speaker on always after BT disconnect"
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/phone/AudioRouter;->mCallManager:Lcom/android/internal/telephony/CallManager;
...
.method public onWiredHeadsetConnection(Z)V
    ...
    invoke-virtual {v2}, Lcom/android/phone/BluetoothManager;->isBluetoothAudioConnectedOrPending()Z
    ...
    iget-object v2, p0, Lcom/android/phone/AudioRouter;->mCallManager:Lcom/android/internal/telephony/CallManager;
    ...
    sget v2, Lcom/android/services/telephony/common/AudioMode;->WIRED_OR_EARPIECE_OR_SPEAKER:I

    invoke-direct {p0, v2}, Lcom/android/phone/AudioRouter;->selectWiredOrEarpieceOrSpeaker(I)I
