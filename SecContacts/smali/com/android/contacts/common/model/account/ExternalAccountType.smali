...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;ZLandroid/content/res/XmlResourceParser;)V
    ...
    iget-boolean v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mHasEditSchema:Z

    if-eqz v5, :cond_4

    const-string v5, "vnd.android.cursor.item/name"

    invoke-direct {p0, v5}, Lcom/android/contacts/common/model/account/ExternalAccountType;->checkKindExists(Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mExtensionPackageNames:Ljava/util/List;

    iget-object v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mInviteActionLabelAttribute:Ljava/lang/String;

    iget-object v6, p0, Lcom/android/contacts/common/model/account/AccountType;->syncAdapterPackageName:Ljava/lang/String;

    const-string v7, "inviteContactActionLabel"

    invoke-static {p1, v5, v6, v7}, Lcom/android/contacts/common/model/account/ExternalAccountType;->resolveExternalResId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I

    move-result v5

    iput v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mInviteActionLabelResId:I

    iget-object v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mViewGroupLabelAttribute:Ljava/lang/String;
    ...
    iput v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mViewGroupLabelResId:I

    iget-object v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mAccountTypeLabelAttribute:Ljava/lang/String;
    ...
    iput v5, p0, Lcom/android/contacts/common/model/account/AccountType;->titleRes:I

    iget-object v5, p0, Lcom/android/contacts/common/model/account/ExternalAccountType;->mAccountTypeIconAttribute:Ljava/lang/String;
    ...
    iput v5, p0, Lcom/android/contacts/common/model/account/AccountType;->iconRes:I

    const/4 v5, 0x1

    iput-boolean v5, p0, Lcom/android/contacts/common/model/account/AccountType;->mIsInitialized:Z
    ...
    const-string v5, "Problem reading XML"
    ...
    :cond_5
    const-string v5, " for external package "
