.class public Lcom/samsung/contacts/sim/MakeSimDBService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/contacts/sim/MakeSimDBService$1;,
        Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;
    }
.end annotation
...
.field private volatile mServiceHandler:Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_FULL_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_PATIAL_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_COMPARE_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_FULL_COMPARE_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_PATIAL_COMPARE_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_EMAILS_PROJECTION:[Ljava/lang/String;

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->NAME_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->NUMBER_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_NUMBER_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_A_NUMBER_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_B_NUMBER_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_C_NUMBER_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->EMAIL_COLUMN_INDEX:I

    sput v4, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_INDEX_COLUMN_INDEX:I

    sput v3, Lcom/samsung/contacts/sim/MakeSimDBService;->mBatchCounter:I

    sput v3, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastBatch:I

    sput v3, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastOneBatchCount:I

    sput v3, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sput-boolean v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mIsBlockFormatMyProfile:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    const/4 v0, 0x0

    iput v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mProviderStatus:I
...
.method private CompareAdnData(III)V
    ...
    iget-object v1, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v2, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->checkProviderState()Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doCompareData(III)V
...
.method static synthetic access$000(Lcom/samsung/contacts/sim/MakeSimDBService;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->doInitAction(II)V

    return-void
.end method

.method static synthetic access$100(Lcom/samsung/contacts/sim/MakeSimDBService;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/samsung/contacts/sim/MakeSimDBService;->doQueryAction(I)V

    return-void
.end method

.method static synthetic access$200(Lcom/samsung/contacts/sim/MakeSimDBService;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/samsung/contacts/sim/MakeSimDBService;->doAirPlaneAction(I)V

    return-void
.end method

.method static synthetic access$300(Lcom/samsung/contacts/sim/MakeSimDBService;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->doCheckAdnAttribute(II)V

    return-void
.end method

.method static synthetic access$400(Lcom/samsung/contacts/sim/MakeSimDBService;IIZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doBtSapAction(IIZ)V
...
.method static synthetic access$500()Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
...
.method private static actuallyImportOneSimContact(Landroid/database/Cursor;Landroid/content/ContentResolver;Landroid/accounts/Account;)V
    ...
    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->NAME_COLUMN_INDEX:I

    invoke-interface {p0, v0}, Landroid/database/Cursor;->getString(I)Ljava/lang/String;

    move-result-object v5

    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->NUMBER_COLUMN_INDEX:I
    ...
    sget v3, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_NUMBER_COLUMN_INDEX:I
    ...
    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_A_NUMBER_COLUMN_INDEX:I

    invoke-interface {p0, v0}, Landroid/database/Cursor;->getString(I)Ljava/lang/String;

    move-result-object v2

    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_B_NUMBER_COLUMN_INDEX:I

    invoke-interface {p0, v0}, Landroid/database/Cursor;->getString(I)Ljava/lang/String;

    move-result-object v1

    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_C_NUMBER_COLUMN_INDEX:I
    ...
    :cond_0
    sget v4, Lcom/samsung/contacts/sim/MakeSimDBService;->EMAIL_COLUMN_INDEX:I

    invoke-interface {p0, v4}, Landroid/database/Cursor;->getString(I)Ljava/lang/String;

    move-result-object v4

    sget v7, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_INDEX_COLUMN_INDEX:I
    ...
    :goto_0
    sget-object v8, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v7, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v5, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v6, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v3, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v2, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mOperationList:Ljava/util/ArrayList;
    ...
    :cond_9
    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mBatchCounter:I

    add-int/lit8 v0, v0, 0x1

    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mBatchCounter:I

    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastOneBatchCount:I

    add-int/lit8 v0, v0, 0x1

    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastOneBatchCount:I
    ...
    sget v1, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastBatch:I
    ...
    sget-object v1, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
...
.method private checkAndUpdateAdnEditable()V
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->isAdnEditable()Z

    move-result v0

    iget-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v3, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I

    invoke-virtual {v2, v3}, Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;->getADNEditable(I)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2, v4}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, v2, v5}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v2, v4}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
...
.method private checkProviderState()Z
    ...
    invoke-virtual {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getContentResolver()Landroid/content/ContentResolver;
    ...
    iget v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mProviderStatus:I
    ...
    :cond_1
    iget v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mProviderStatus:I
...
.method private doAirPlaneAction(I)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    const-string v2, "@@ doAirPlaneAction : stop Service and send broadcasting com.samsung.intent.action.PB_SYNC startId:"
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/contacts/sim/MakeSimDBService;->sendBroadcast(Landroid/content/Intent;)V

    invoke-virtual {p0, p1}, Lcom/samsung/contacts/sim/MakeSimDBService;->stopSelfResult(I)Z
...
.method private doBtSapAction(IIZ)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->doDeleteSimDB(III)V
...
.method private doCheckAdnAttribute(II)V
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->isFDNEnabled()Z
    ...
    invoke-direct {p0, v2, v6}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I

    move-result v2

    sget-object v3, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v7}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v1, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I

    invoke-virtual {v0, v1}, Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;->getFdnOnAdnDeleted(I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0, v7}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V

    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->preserveInitStatusForFDN()V
    ...
    invoke-direct {p0, v0, v6}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, v0, v6}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v2, v6}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V

    goto :goto_0

    :cond_3
    invoke-direct {p0, p1, v8, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->doLastAction(III)V

    goto :goto_1

    :cond_4
    invoke-virtual {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->CompareAdnData(III)V
...
.method private doCheckSimState(II)V
    ...
    iget-object v8, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mTelMan:Landroid/telephony/TelephonyManager;

    invoke-virtual {v8}, Landroid/telephony/TelephonyManager;->getSimState()I

    move-result v7

    sget-object v8, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    :goto_0
    iget-object v8, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v9, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
    ...
    invoke-direct {p0, p1, v8, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->doDeleteSimDB(III)V
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->isIccCardChanged()Z
    ...
    :goto_3
    sget-boolean v8, Lcom/samsung/contacts/sim/MakeSimDBService;->mIsBlockFormatMyProfile:Z
    ...
    invoke-direct {p0, v8, v9}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p1, v8, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->CompareAdnData(III)V
    ...
    :cond_8
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->doWriteSIMProfile()V

    const-string v8, "setInitialMyProfile"

    const/4 v9, 0x1

    invoke-direct {p0, v8, v9}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
...
.method private doCompareData(III)V
    ...
    invoke-direct {v0, v1}, Lcom/samsung/contacts/sim/MakeSimDBService;->getProjection(I)[Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v4, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getCallingUri()Landroid/net/Uri;
    ...
    invoke-direct/range {p0 .. p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doDeleteSimDB(III)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct/range {p0 .. p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doLastAction(III)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sget-object v1, Lcom/samsung/contacts/sim/MakeSimDBService$1;->$SwitchMap$android$database$CursorJoiner$Result:[I
    ...
    iget-object v4, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;

    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;
    ...
    sget-object v6, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_EMAILS_PROJECTION:[Ljava/lang/String;
    ...
    sget-object v1, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_EMAILS_PROJECTION:[Ljava/lang/String;

    sget-object v2, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_EMAILS_PROJECTION:[Ljava/lang/String;
...
.method private doDeleteSIMProfile(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;
...
.method private doDeleteSimDB(III)V
    ...
    iget-object v4, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v5, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doLastAction(III)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doWriteSimDB(III)V
...
.method private doInitAction(II)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/samsung/contacts/sim/MakeSimDBService;->doCheckSimState(II)V
...
.method private doLastAction(III)V
    ...
    invoke-direct {p0, v0, v2}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V

    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->setRuntimeFirstBootTime()V
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->checkAndUpdateAdnEditable()V
    ...
    invoke-virtual {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    :cond_1
    invoke-direct {p0, p3}, Lcom/samsung/contacts/sim/MakeSimDBService;->doStopService(I)V
    ...
    sget-object v2, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    invoke-direct {p0, v4, v5}, Lcom/samsung/contacts/sim/MakeSimDBService;->updateSettingStatus(J)V
    ...
    invoke-direct {p0, v1}, Lcom/samsung/contacts/sim/MakeSimDBService;->updateAdnDeletedStatus(I)V
    ...
    sget-object v4, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v3}, Lcom/samsung/contacts/sim/MakeSimDBService;->updateSettingStatus(J)V
...
.method private doQueryAction(I)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, v1, v2}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V

    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/contacts/sim/MakeSimDBService;->doStopService(I)V
...
.method private doStopService(I)V
    ...
    sget-boolean v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mIsBlockFormatMyProfile:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->isSetupWizard()Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
...
.method private doWriteSIMProfile()V
    ...
    iget-object v2, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mTelMan:Landroid/telephony/TelephonyManager;
    ...
    :cond_1
    sget-boolean v2, Lcom/samsung/contacts/sim/MakeSimDBService;->mIsBlockFormatMyProfile:Z
    ...
    invoke-direct {v0, v2, v4}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    invoke-direct {v0, v1}, Lcom/samsung/contacts/sim/MakeSimDBService;->doDeleteSIMProfile(Ljava/lang/String;)Z
    ...
    iget-object v2, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;
    ...
    iget-object v6, v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;
    ...
    :try_start_2
    invoke-virtual/range {p0 .. p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getResources()Landroid/content/res/Resources;
...
.method private doWriteSimDB(III)V
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getCallingUri()Landroid/net/Uri;

    move-result-object v1

    const/4 v2, 0x1

    invoke-direct {p0, v2}, Lcom/samsung/contacts/sim/MakeSimDBService;->getProjection(I)[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mCursor:Landroid/database/Cursor;

    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mCursor:Landroid/database/Cursor;
    ...
    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastBatch:I
    ...
    sget v2, Lcom/samsung/contacts/sim/MakeSimDBService;->mLastBatch:I
    ...
    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v0}, Landroid/os/PowerManager$WakeLock;->acquire()V

    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mCursor:Landroid/database/Cursor;

    invoke-direct {p0, v0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getColumnIndex(Landroid/database/Cursor;)V
    ...
    iget-object v1, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;

    iget-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mAccount:Landroid/accounts/Account;

    invoke-static {v0, v1, v2}, Lcom/samsung/contacts/sim/MakeSimDBService;->actuallyImportOneSimContact(Landroid/database/Cursor;Landroid/content/ContentResolver;Landroid/accounts/Account;)V
...
.method private getColumnIndex(Landroid/database/Cursor;)V
    ...
    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->NAME_COLUMN_INDEX:I
    ...
    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->NUMBER_COLUMN_INDEX:I
    ...
    sput v1, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_NUMBER_COLUMN_INDEX:I

    const/4 v1, 0x3

    if-le v0, v1, :cond_0

    const-string v0, "anrA_number"

    invoke-interface {p1, v0}, Landroid/database/Cursor;->getColumnIndex(Ljava/lang/String;)I

    move-result v0

    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_A_NUMBER_COLUMN_INDEX:I

    const-string v0, "anrB_number"

    invoke-interface {p1, v0}, Landroid/database/Cursor;->getColumnIndex(Ljava/lang/String;)I

    move-result v0

    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_B_NUMBER_COLUMN_INDEX:I

    const-string v0, "anrC_number"

    invoke-interface {p1, v0}, Landroid/database/Cursor;->getColumnIndex(Ljava/lang/String;)I

    move-result v0

    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ANR_C_NUMBER_COLUMN_INDEX:I
    ...
    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->EMAIL_COLUMN_INDEX:I
    ...
    sput v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_INDEX_COLUMN_INDEX:I
...
.method private getProjection(I)[Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_COMPARE_PROJECTION:[Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_FULL_COMPARE_PROJECTION:[Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_PATIAL_COMPARE_PROJECTION:[Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_FULL_PROJECTION:[Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_ANR_PATIAL_PROJECTION:[Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/contacts/sim/MakeSimDBService;->ADN_PROJECTION:[Ljava/lang/String;
...
.method private getSimAccountStatus()J
    ...
    iget-object v3, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;
...
.method private isAdnEditable()Z
    ...
    sget v0, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
    ...
    :cond_3
    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mTelMan:Landroid/telephony/TelephonyManager;
...
.method private isIccCardChanged()Z
    ...
    iget-object v7, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v8, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
    ...
    iget-object v6, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v7, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
...
.method private preserveInitStatusForFDN()V
    ...
    invoke-direct {p0}, Lcom/samsung/contacts/sim/MakeSimDBService;->getSimAccountStatus()J
    ...
    invoke-direct {p0, v2, v3}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V
...
.method private sendMessage(III)V
    ...
    iget-object v1, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mServiceHandler:Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;

    invoke-virtual {v1}, Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;->obtainMessage()Landroid/os/Message;
    ...
    invoke-virtual {v1, v0}, Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;->sendMessage(Landroid/os/Message;)Z
...
.method private setRuntimeFirstBootTime()V
    ...
    iget-object v5, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mMakeSimOperation:Lcom/samsung/contacts/sim/makesimdbservice/MakeSimOperation;

    sget v6, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I
...
.method private updateSettingStatus(J)V
    ...
    iget-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;
...
.method public onCreate()V
    ...
    iput-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mResolver:Landroid/content/ContentResolver;
    ...
    iput-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mAccount:Landroid/accounts/Account;

    const-string v2, "power"

    invoke-virtual {p0, v2}, Lcom/samsung/contacts/sim/MakeSimDBService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v2, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mTelMan:Landroid/telephony/TelephonyManager;
...
.method public onDestroy()V
    ...
    :goto_0
    iget-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mServiceLooper:Landroid/os/Looper;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    :goto_0
    iget-object v7, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mServiceHandler:Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;
    ...
    sget-object v6, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    sput v7, Lcom/samsung/contacts/sim/MakeSimDBService;->mSimSlotId:I

    sget-object v7, Lcom/samsung/contacts/sim/MakeSimDBService;->TAG:Ljava/lang/String;
    ...
    invoke-direct {p0, v2, p3, v6}, Lcom/samsung/contacts/sim/MakeSimDBService;->sendMessage(III)V
    ...
    invoke-direct {p0, v2, p3, v10}, Lcom/samsung/contacts/sim/MakeSimDBService;->sendMessage(III)V

    goto :goto_3

    :cond_3
    invoke-direct {p0, v2, p3, v11}, Lcom/samsung/contacts/sim/MakeSimDBService;->sendMessage(III)V
    ...
    invoke-direct {p0, v7, v10}, Lcom/samsung/contacts/sim/MakeSimDBService;->getIntPreferenceValue(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, v7, v10}, Lcom/samsung/contacts/sim/MakeSimDBService;->setIntPreferenceValue(Ljava/lang/String;I)V

    :cond_4
    invoke-direct {p0, v2, p3, v5}, Lcom/samsung/contacts/sim/MakeSimDBService;->sendMessage(III)V
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mServiceLooper:Landroid/os/Looper;

    new-instance v0, Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;

    invoke-direct {v0, p0}, Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;-><init>(Lcom/samsung/contacts/sim/MakeSimDBService;)V

    iput-object v0, p0, Lcom/samsung/contacts/sim/MakeSimDBService;->mServiceHandler:Lcom/samsung/contacts/sim/MakeSimDBService$ServiceHandler;
