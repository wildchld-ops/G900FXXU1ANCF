...
.method private final LoadInitData()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->getApplicationContext()Landroid/content/Context;
...
.method private final UpdateSmsc()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->finish()V
...
.method static synthetic access$400(Lcom/android/mms/settings/MessageSmscActivityDS;)V
    .locals 0
...
.method static synthetic access$500(Lcom/android/mms/settings/MessageSmscActivityDS;)V
    .locals 0
...
.method private final cancel()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/MessageSmscActivityDS;->setResult(I)V

    invoke-virtual {p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->finish()V
...
.method private updateActionBar()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    invoke-virtual {p0, v5}, Lcom/android/mms/settings/MessageSmscActivityDS;->getString(I)Ljava/lang/String;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->getResources()Landroid/content/res/Resources;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mIsLandscape:Z

    invoke-virtual {p0}, Lcom/android/mms/settings/MessageSmscActivityDS;->getActionBar()Landroid/app/ActionBar;
    ...
    sput-boolean v3, Lcom/android/mms/settings/MessageSmscActivityDS;->simActive1:Z
    ...
    sput-boolean v3, Lcom/android/mms/settings/MessageSmscActivityDS;->simActive2:Z

    const-string v3, "Mms/MessageSmscActivityDS"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "(onCreate)simActive1: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-boolean v7, Lcom/android/mms/settings/MessageSmscActivityDS;->simActive1:Z

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, " simActive2: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-boolean v7, Lcom/android/mms/settings/MessageSmscActivityDS;->simActive2:Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/mms/settings/MessageSmscActivityDS;->setContentView(I)V

    invoke-virtual {p0, v8}, Lcom/android/mms/settings/MessageSmscActivityDS;->findViewById(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Landroid/widget/EditText;

    iput-object v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mSmscEditor:Landroid/widget/EditText;
    ...
    invoke-virtual {p0, v3}, Lcom/android/mms/settings/MessageSmscActivityDS;->findViewById(I)Landroid/view/View;
    ...
    new-instance v3, Lcom/android/mms/settings/MessageSmscActivityDS$2;

    invoke-direct {v3, p0}, Lcom/android/mms/settings/MessageSmscActivityDS$2;-><init>(Lcom/android/mms/settings/MessageSmscActivityDS;)V

    invoke-virtual {v2, v3}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v3, Lcom/android/mms/settings/MessageSmscActivityDS$3;

    invoke-direct {v3, p0}, Lcom/android/mms/settings/MessageSmscActivityDS$3;-><init>(Lcom/android/mms/settings/MessageSmscActivityDS;)V
    ...
    iput-object v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabs:Landroid/widget/TabHost;
    ...
    invoke-static {p0, v5, v4, v5}, Lcom/android/mms/ui/MessageUtils;->getSimIcon(Landroid/content/Context;IIZ)I
    ...
    invoke-virtual {v3, v6, v7}, Landroid/widget/TabHost$TabSpec;->setIndicator(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)Landroid/widget/TabHost$TabSpec;

    move-result-object v3

    iput-object v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabSpec1:Landroid/widget/TabHost$TabSpec;
    ...
    invoke-static {p0, v4, v4, v5}, Lcom/android/mms/ui/MessageUtils;->getSimIcon(Landroid/content/Context;IIZ)I
    ...
    invoke-virtual {v3, v6, v4}, Landroid/widget/TabHost$TabSpec;->setIndicator(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)Landroid/widget/TabHost$TabSpec;

    move-result-object v3

    iput-object v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabSpec2:Landroid/widget/TabHost$TabSpec;

    iget-object v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabs:Landroid/widget/TabHost;

    new-instance v4, Lcom/android/mms/settings/MessageSmscActivityDS$1;

    invoke-direct {v4, p0}, Lcom/android/mms/settings/MessageSmscActivityDS$1;-><init>(Lcom/android/mms/settings/MessageSmscActivityDS;)V
    ...
    sget-object v4, Lcom/android/mms/settings/MessageSmscActivityDS;->Smsc2:Ljava/lang/String;

    invoke-virtual {v3, v4}, Landroid/widget/EditText;->setText(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mSmscEditor:Landroid/widget/EditText;

    iget-object v4, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mSmscEditor:Landroid/widget/EditText;
    ...
    iget-object v4, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabSpec1:Landroid/widget/TabHost$TabSpec;
    ...
    iget-object v4, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabSpec2:Landroid/widget/TabHost$TabSpec;
...
.method public onResume()V
    ...
    sget v4, Lcom/android/mms/settings/MessageSmscActivityDS;->mInsertedSimNum:I

    if-le v4, v8, :cond_0

    sget-boolean v4, Lcom/android/mms/settings/MessageSmscActivityDS;->simActive1:Z

    if-eqz v4, :cond_0

    sget-boolean v4, Lcom/android/mms/settings/MessageSmscActivityDS;->simActive2:Z
    ...
    iget-object v4, p0, Lcom/android/mms/settings/MessageSmscActivityDS;->mTabs:Landroid/widget/TabHost;
    ...
    invoke-static {p0, v3, v8, v7}, Lcom/android/mms/ui/MessageUtils;->getSimIcon(Landroid/content/Context;IIZ)I
