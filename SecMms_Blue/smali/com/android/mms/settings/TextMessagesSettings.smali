...
.method private refreshSIMPreferences()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/TextMessagesSettings;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {p0, v6}, Lcom/android/mms/settings/TextMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    :goto_1
    invoke-virtual {p0, v5}, Lcom/android/mms/settings/TextMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method private setSmscSummary(Landroid/content/SharedPreferences;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/TextMessagesSettings;->getPreferenceManager()Landroid/preference/PreferenceManager;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/TextMessagesSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/TextMessagesSettings;->addPreferencesFromResource(I)V

    :goto_0
    const-string v2, "pref_key_sms_reassembly"

    invoke-virtual {p0, v2}, Lcom/android/mms/settings/TextMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/mms/settings/TextMessagesSettings;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/mms/settings/TextMessagesSettings;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method protected onDestroy()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/TextMessagesSettings;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/TextMessagesSettings;->finish()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/mms/settings/TextMessagesSettings;->startActivity(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/mms/settings/TextMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected setSmsPreferences()V
    ...
    invoke-virtual {p0, v4}, Lcom/android/mms/settings/TextMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/TextMessagesSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
