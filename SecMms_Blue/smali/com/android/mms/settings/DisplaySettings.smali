...
.method private setPreferenceSummary()V
    ...
    invoke-virtual {p0, v7}, Lcom/android/mms/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v4

    if-eqz v4, :cond_0

    invoke-virtual {p0}, Lcom/android/mms/settings/DisplaySettings;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {p0, v8}, Lcom/android/mms/settings/DisplaySettings;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DisplaySettings;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v13}, Lcom/android/mms/settings/DisplaySettings;->getString(I)Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DisplaySettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/DisplaySettings;->addPreferencesFromResource(I)V

    const-string v1, "pref_key_split_view"

    invoke-virtual {p0, v1}, Lcom/android/mms/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/DisplaySettings;->finish()V
...
.method protected setOthersPreferences()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/android/mms/ui/FontSizePreference;

    invoke-virtual {p0}, Lcom/android/mms/settings/DisplaySettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0, v3}, Lcom/android/mms/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/DisplaySettings;->getString(I)Ljava/lang/String;
