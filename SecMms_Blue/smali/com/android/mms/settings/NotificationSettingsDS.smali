...
.method private setupSimTab(I)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/NotificationSettingsDS;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    const/4 v6, 0x0

    invoke-static {p0, p1, v7, v6}, Lcom/android/mms/ui/MessageUtils;->getSimIcon(Landroid/content/Context;IIZ)I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/NotificationSettingsDS;->getActionBar()Landroid/app/ActionBar;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/mms/settings/NotificationSettingsDS;->getTabHost()Landroid/widget/TabHost;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/NotificationSettingsDS;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/NotificationSettingsDS;->finish()V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/NotificationSettingsDS;->getApplicationContext()Landroid/content/Context;
...
.method public onResume()V
    ...
    :goto_0
    sget v4, Lcom/android/mms/settings/NotificationSettingsDS;->mInsertedSimNum:I

    if-ge v3, v4, :cond_0

    sget-object v4, Lcom/android/mms/settings/NotificationSettingsDS;->mTabHost:Landroid/widget/TabHost;
