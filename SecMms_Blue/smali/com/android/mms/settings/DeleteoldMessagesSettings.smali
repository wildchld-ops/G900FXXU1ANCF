...
.method private setElementEnable()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/mms/settings/DeleteoldMessagesSettings;->mRestoreSDPref:Landroid/preference/Preference;
...
.method private setMmsDisplayLimit()V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method private showMmsLimitMessagePickerDialog()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->getString(I)Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    iput-object v1, p0, Lcom/android/mms/settings/DeleteoldMessagesSettings;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->addPreferencesFromResource(I)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->finish()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    iget-object v1, p0, Lcom/android/mms/settings/DeleteoldMessagesSettings;->mSmsLimitPref:Landroid/preference/Preference;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/mms/settings/DeleteoldMessagesSettings;->mMmsLimitPref:Landroid/preference/Preference;
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/mms/settings/DeleteoldMessagesSettings;->mRestoreSDPref:Landroid/preference/Preference;

    if-ne p2, v1, :cond_0

    new-instance v0, Landroid/content/Intent;

    const-class v1, Lcom/samsung/mms/ui/SavedMsgsList;
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method protected setOthersPreferences()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    const-string v0, "pref_key_sms_restore"

    invoke-virtual {p0, v0}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    iput-object v0, p0, Lcom/android/mms/settings/DeleteoldMessagesSettings;->mRestoreSDPref:Landroid/preference/Preference;
    ...
    const-string v1, "pref_key_sms_restore"

    invoke-virtual {p0, v1}, Lcom/android/mms/settings/DeleteoldMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
