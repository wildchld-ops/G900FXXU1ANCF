...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/SpamSettings;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    iput-object v1, p0, Lcom/android/mms/settings/SpamSettings;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/android/mms/settings/SpamSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/SpamSettings;->addPreferencesFromResource(I)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/SpamSettings;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/SpamSettings;->finish()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/SpamSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/SpamSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/SpamSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/SpamSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected onStop()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/SpamSettings;->getWindow()Landroid/view/Window;
...
.method protected setOthersPreferences()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/SpamSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
