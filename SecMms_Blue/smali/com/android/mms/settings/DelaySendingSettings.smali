...
.method private setMessageDealySummary(Landroid/content/SharedPreferences;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v5}, Lcom/android/mms/settings/DelaySendingSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    iput-object v1, p0, Lcom/android/mms/settings/DelaySendingSettings;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/DelaySendingSettings;->addPreferencesFromResource(I)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->finish()V
...
.method protected onPause()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/DelaySendingSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected onStop()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/DelaySendingSettings;->getWindow()Landroid/view/Window;
