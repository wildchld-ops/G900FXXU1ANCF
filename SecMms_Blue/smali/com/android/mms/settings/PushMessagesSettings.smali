...
.method private setServiceLoadingSummary(Landroid/content/SharedPreferences;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/PushMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/PushMessagesSettings;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    iput-object v1, p0, Lcom/android/mms/settings/PushMessagesSettings;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/android/mms/settings/PushMessagesSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/mms/settings/PushMessagesSettings;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/PushMessagesSettings;->addPreferencesFromResource(I)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/PushMessagesSettings;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/PushMessagesSettings;->finish()V
...
.method protected onPause()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/PushMessagesSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method protected setOthersPreferences()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/PushMessagesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
