...
.method private setCmasReminderSummary(Landroid/content/SharedPreferences;)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/mms/settings/CMASSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CMASSettings;->getResources()Landroid/content/res/Resources;
...
.method private setVibrateMenu()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/CMASSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private showCMASPreviewDialog()V
    ...
    invoke-virtual {v0}, Lcom/android/mms/ui/CMASPreviewDialog;->isShowing()Z
...
.method private updateNotificationAlert()V
    ...
    invoke-virtual {p0, v4}, Lcom/android/mms/settings/CMASSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/mms/settings/CMASSettings;->getPreferenceManager()Landroid/preference/PreferenceManager;
    ...
    invoke-virtual {p0, v4}, Lcom/android/mms/settings/CMASSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    check-cast v3, Lcom/android/mms/settings/MessagingSettingsSwitch;
    ...
    invoke-virtual {v3}, Lcom/android/mms/settings/MessagingSettingsSwitch;->isChecked()Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CMASSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/CMASSettings;->addPreferencesFromResource(I)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/CMASSettings;->finish()V
...
.method protected onPause()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CMASSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/CMASSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/CMASSettings;->startActivity(Landroid/content/Intent;)V
...
.method protected onStop()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CMASSettings;->getWindow()Landroid/view/Window;
...
.method protected setOthersPreferences()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/CMASSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/CMASSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
