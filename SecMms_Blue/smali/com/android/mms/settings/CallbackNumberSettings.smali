...
.method private setCallbackNumber(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/CallbackNumberSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private setCallbackNumberSummary(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CallbackNumberSettings;->getApplicationContext()Landroid/content/Context;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CallbackNumberSettings;->getActionBar()Landroid/app/ActionBar;
    ...
    invoke-virtual {p0, v1}, Lcom/android/mms/settings/CallbackNumberSettings;->addPreferencesFromResource(I)V

    const-string v1, "pref_key_callback_text"

    invoke-virtual {p0, v1}, Lcom/android/mms/settings/CallbackNumberSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CallbackNumberSettings;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/mms/settings/CallbackNumberSettings;->finish()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/CallbackNumberSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v0}, Lcom/android/mms/settings/CallbackNumberSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CallbackNumberSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/settings/CallbackNumberSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected onStop()V
    ...
    invoke-virtual {p0}, Lcom/android/mms/settings/CallbackNumberSettings;->getWindow()Landroid/view/Window;
