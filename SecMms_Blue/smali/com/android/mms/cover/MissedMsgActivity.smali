...
.method private initActivity()V
    ...
    invoke-direct {p0, v3, v3, v4}, Lcom/android/mms/cover/MissedMsgActivity;->setMissedMsgInfo(IZZ)V
...
.method private initMissedMsgInfos(Landroid/content/Context;J)V
    ...
    invoke-static {v8, v2, v4}, Lcom/android/mms/ui/MessageUtils;->extractEncStrFromCursor(Landroid/database/Cursor;II)Ljava/lang/String;
...
.method private initResourceLayout()V
    ...
    iput-object v2, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMissedMsgMainView:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Lcom/android/mms/cover/MissedMsgActivity;->mAnimLayout:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Lcom/android/mms/cover/MissedMsgActivity;->mBackgroundColorLayout:Landroid/widget/LinearLayout;
...
.method private setMissedMsgInfo(IZZ)V
    ...
    const-string v5, "setMissedMsgInfo() index = "
    ...
    iput-object v6, p0, Lcom/android/mms/cover/MissedMsgActivity;->mCmasType:Ljava/lang/String;

    if-ltz p1, :cond_0

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMsgIds:Ljava/util/ArrayList;
    ...
    const-string v4, "There is no unread message"

    invoke-static {v3, v4}, Lcom/android/mms/Log;->e(Ljava/lang/String;Ljava/lang/String;)V

    iput-boolean v9, p0, Lcom/android/mms/cover/MissedMsgActivity;->mIsInvalidMessage:Z
    ...
    invoke-static {v3, v4, v6, v5, v10}, Lcom/android/mms/animation/MsgObjectAnimation;->createSlideXByPercent(JLandroid/view/animation/Interpolator;FF)Landroid/view/animation/TranslateAnimation;
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mAnimLayout:Landroid/widget/LinearLayout;
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->conversation:Lcom/android/mms/data/Conversation;

    invoke-virtual {v3}, Lcom/android/mms/data/Conversation;->getRecipients()Lcom/android/mms/data/ContactList;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/android/mms/cover/MissedMsgActivity;->getContactHeaderString(Lcom/android/mms/data/ContactList;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mRecipients:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mRecipientView:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v3}, Lcom/android/mms/cover/MissedMsgActivity;->getContactNumberString(Lcom/android/mms/data/ContactList;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mRecipientNumbers:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mRecipientNumberView:Landroid/widget/TextView;

    iget-object v4, p0, Lcom/android/mms/cover/MissedMsgActivity;->mRecipientNumbers:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mCmasType:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMsgTypes:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, v5, v6, p1}, Lcom/android/mms/cover/MissedMsgActivity;->parsingPdu(Landroid/content/Context;JI)V

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMmsIndicatorView:Landroid/widget/TextView;

    invoke-virtual {v3, v7}, Landroid/widget/TextView;->setVisibility(I)V

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mAttachmentBitmap:Landroid/graphics/Bitmap;

    if-eqz v3, :cond_6

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMmsImageView:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMsgCountView:Landroid/widget/TextView;
    ...
    iget v5, p0, Lcom/android/mms/cover/MissedMsgActivity;->mTotalUnreadMsgCount:I
    ...
    :goto_3
    iget-object v4, p0, Lcom/android/mms/cover/MissedMsgActivity;->mDateView:Landroid/widget/TextView;

    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMsgTimes:Ljava/util/ArrayList;
    ...
    invoke-static {p0, v5, v6}, Lcom/android/mms/ui/MessageUtils;->formatDateTime(Landroid/content/Context;J)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mHandler:Landroid/os/Handler;

    new-instance v4, Lcom/android/mms/cover/MissedMsgActivity$5;

    invoke-direct {v4, p0}, Lcom/android/mms/cover/MissedMsgActivity$5;-><init>(Lcom/android/mms/cover/MissedMsgActivity;)V
    ...
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMsgBodys:Ljava/util/ArrayList;
    ...
    :cond_8
    iget-object v3, p0, Lcom/android/mms/cover/MissedMsgActivity;->mMessageBodyView:Landroid/widget/TextView;
    ...
    :cond_a
    new-instance v3, Lcom/android/mms/cover/MissedMsgActivity$6;

    invoke-direct {v3, p0}, Lcom/android/mms/cover/MissedMsgActivity$6;-><init>(Lcom/android/mms/cover/MissedMsgActivity;)V

    iget v4, p0, Lcom/android/mms/cover/MissedMsgActivity;->mCurrentIdx:I

    invoke-direct {p0, v3, v4, v7}, Lcom/android/mms/cover/MissedMsgActivity;->markAsRead(Ljava/lang/Runnable;IZ)V
...
.method private setPreviewMsgInfo(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lcom/android/mms/cover/MissedMsgActivity;->getContentResolver()Landroid/content/ContentResolver;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/cover/MissedMsgActivity;->setContentView(I)V
...
.method protected onDestroy()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/mms/cover/MissedMsgActivity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
