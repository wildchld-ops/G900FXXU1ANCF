...
.method private handleSiMessage(Lcom/android/mms/transaction/WapPushMessage;)V
    ...
    invoke-static {p0, v1, v5, v6}, Lcom/android/mms/transaction/MessagingNotification;->blockingUpdateNewMessageIndicator(Landroid/content/Context;Landroid/net/Uri;ZI)V
...
.method private handleSlMeeesage(Lcom/android/mms/transaction/WapPushMessage;)V
    ...
    const-string v10, "handleSlMessage."
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/mms/transaction/WapPushReceiverService;->selectWPMInfoByHref(ILjava/lang/String;)Lcom/android/mms/transaction/WapPushReceiverService$WPMInfo;
    ...
    invoke-static {v9}, Lcom/android/mms/transaction/WapPushMessage;->slActionToPriority(I)I
    ...
    const-string v8, "Mms/WapPushReceiverService"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "discard message because of priority. , recv_action_priority= "
    ...
    const-string v10, ", stored_action+priority= "
    ...
    invoke-direct {p0, v9}, Lcom/android/mms/transaction/WapPushReceiverService;->deleteWPMInfo(I)V
    ...
    invoke-direct {p0, v7}, Lcom/android/mms/transaction/WapPushReceiverService;->insertWPMInfo(Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-static {p0, v1, v0, v9}, Lcom/android/mms/transaction/MessagingNotification;->blockingUpdateNewMessageIndicator(Landroid/content/Context;Landroid/net/Uri;ZI)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/mms/transaction/WapPushReceiverService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v8, p0}, Lcom/android/mms/transaction/WapPushReceiverService;->processHref(Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-class v9, Lcom/android/mms/ui/PushMessageDialog;
...
.method public static processHref(Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-string v3, "Mms/WapPushReceiverService"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "processUri uri="
