...
.method public SpamOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    sget-object v5, Lcom/android/mms/util/DummyFramework$SpamMms;->CONTENT_URI:Landroid/net/Uri;
    ...
    invoke-direct {v0, p0, v2, v3, v4}, Lcom/android/mms/ui/MessageOptions$DeleteMessageListener;-><init>(Lcom/android/mms/ui/MessageOptions;Landroid/net/Uri;ZZ)V
    ...
    :cond_1
    sget-object v5, Lcom/android/mms/util/DummyFramework$SpamSms;->CONTENT_URI:Landroid/net/Uri;
...
.method public forwardMessage(ZLcom/android/mms/ui/MessageItem;Ljava/lang/Runnable;Z)V
    ...
    invoke-static {v6, v0}, Lcom/android/mms/util/TelephonyUtils;->substringByByteSizeUtf8(Ljava/lang/String;I)Ljava/lang/String;
...
.method public optionItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mMsgItem:Lcom/android/mms/ui/MessageItem;
    ...
    sget v11, Lcom/android/mms/ui/MessageOptions;->mLaunchApp:I
    ...
    iget-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mActivity:Landroid/app/Activity;

    const-wide/16 v12, 0x0

    invoke-static {v11, v12, v13}, Lcom/android/mms/ui/ComposeMessageFragment;->createIntent(Landroid/content/Context;J)Landroid/content/Intent;
    ...
    iget-object v12, v0, Lcom/android/mms/ui/MessageOptions;->mMsgItem:Lcom/android/mms/ui/MessageItem;
    ...
    invoke-virtual {v11, v3}, Landroid/app/Activity;->startActivity(Landroid/content/Intent;)V
    ...
    const-string v11, "fromFolderView"

    const/4 v12, 0x1

    invoke-virtual {v3, v11, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v11, "replyComposer"
    ...
    sput-boolean v11, Lcom/android/mms/ui/MessageOptions;->sReplyLaunched:Z
    ...
    iget-object v12, v0, Lcom/android/mms/ui/MessageOptions;->mConversation:Lcom/android/mms/data/Conversation;

    const/4 v13, 0x1

    move-object/from16 v0, p0

    invoke-virtual {v0, v11, v12, v13}, Lcom/android/mms/ui/MessageOptions;->resendMessage(Lcom/android/mms/ui/MessageItem;Lcom/android/mms/data/Conversation;Z)Z

    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mActivity:Landroid/app/Activity;

    instance-of v11, v11, Lcom/android/mms/ui/BoxListViewActivity;
    ...
    check-cast v11, Lcom/android/mms/ui/BoxListViewActivity;

    const/4 v12, 0x0

    invoke-virtual {v11, v12}, Lcom/android/mms/ui/BoxListViewActivity;->notifyBoxDataChanged(Z)V
    ...
    invoke-static {v11, v12}, Lcom/android/mms/util/TelephonyUtils;->checkPSAvailability(Landroid/content/Context;Z)Z
    ...
    invoke-virtual {v12}, Lcom/android/mms/ui/MessageItem;->getBodyAll()Ljava/lang/String;

    move-result-object v12

    invoke-static {v11, v12}, Lcom/android/mms/util/UIUtils;->copyToClipboard(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget v13, v0, Lcom/android/mms/ui/MessageOptions;->mCurSlideLocation:I

    invoke-virtual {v12, v13}, Lcom/android/mms/ui/MessageItem;->getBodyAt(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v11, v12}, Lcom/android/mms/ui/MessageOptions;->copyMessageToSIM(Lcom/android/mms/ui/MessageItem;Lcom/android/mms/data/Conversation;)V
    ...
    invoke-virtual {v0, v11}, Lcom/android/mms/ui/MessageOptions;->copyMessageToSDCARD(Lcom/android/mms/ui/MessageItem;)V
    ...
    instance-of v11, v11, Lcom/android/mms/ui/SlideshowActivity;
    ...
    invoke-virtual {v0, v4, v11, v12}, Lcom/android/mms/ui/MessageOptions;->forwardMessage(ZLcom/android/mms/ui/MessageItem;Z)V
    ...
    invoke-virtual {v0, v11, v12}, Lcom/android/mms/ui/MessageOptions;->forwardMessage(ZLcom/android/mms/ui/MessageItem;)V
    ...
    invoke-virtual {v0, v11, v12, v13}, Lcom/android/mms/ui/MessageOptions;->viewMessageDetail(Lcom/android/mms/ui/MessageItem;Lcom/android/mms/data/Conversation;Z)V
    ...
    :pswitch_8
    sget-object v11, Lcom/android/mms/ui/MessageOptions;->mType:Ljava/lang/String;

    move-object/from16 v0, p0

    invoke-direct {v0, v11}, Lcom/android/mms/ui/MessageOptions;->islockmessage(Ljava/lang/String;)Z
    ...
    iget-object v10, v11, Lcom/android/mms/ui/MessageItem;->mMessageUri:Landroid/net/Uri;

    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mMsgItem:Lcom/android/mms/ui/MessageItem;

    invoke-virtual {v11}, Lcom/android/mms/ui/MessageItem;->isGroupSms()Z

    move-result v11

    if-eqz v11, :cond_d

    sget-object v11, Lcom/android/mms/ui/MessageUtils;->SMS_GROUP_CONTENT_URI:Landroid/net/Uri;
    ...
    :cond_d
    new-instance v6, Lcom/android/mms/ui/MessageOptions$DeleteMessageListener;

    const/4 v11, 0x0

    move-object/from16 v0, p0

    invoke-direct {v6, v0, v10, v5, v11}, Lcom/android/mms/ui/MessageOptions$DeleteMessageListener;-><init>(Lcom/android/mms/ui/MessageOptions;Landroid/net/Uri;ZZ)V

    move-object/from16 v0, p0

    invoke-direct {v0, v6, v5}, Lcom/android/mms/ui/MessageOptions;->confirmDeleteDialog(Landroid/content/DialogInterface$OnClickListener;Z)V
    ...
    iget-object v11, v11, Lcom/android/mms/ui/MessageItem;->mSlideshow:Lcom/android/mms/model/SlideshowModel;

    const/4 v12, 0x1

    sget-wide v13, Lcom/android/mms/ui/MessageOptions;->msgId:J

    move-object/from16 v0, p0

    invoke-virtual {v0, v11, v12, v13, v14}, Lcom/android/mms/ui/MessageOptions;->showAttachmentList(Lcom/android/mms/model/SlideshowModel;ZJ)V
    ...
    invoke-static/range {v14 .. v16}, Lcom/android/mms/ui/MessageUtils;->saveRingtone(Landroid/content/Context;J)Z

    move-result v14

    invoke-static {v11, v12, v13, v14}, Lcom/android/mms/ui/MessageUtils;->getDrmMimeSavedStringRsrc(Landroid/content/Context;JZ)I
    ...
    invoke-static {v11, v7, v12}, Landroid/widget/Toast;->makeText(Landroid/content/Context;II)Landroid/widget/Toast;
    ...
    iget-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mContext:Landroid/content/Context;
    ...
    iget-object v13, v0, Lcom/android/mms/ui/MessageOptions;->numberList:Ljava/util/ArrayList;

    move-object/from16 v0, p0

    invoke-virtual {v0, v11, v12, v13}, Lcom/android/mms/ui/MessageOptions;->ReplyAllMessage(Landroid/content/Context;Lcom/android/mms/ui/MessageItem;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v11, v12}, Lcom/android/mms/ui/MessageOptions;->lockMessage(Lcom/android/mms/ui/MessageItem;Z)V

    const/4 v11, 0x1

    move-object/from16 v0, p0

    invoke-virtual {v0, v11}, Lcom/android/mms/ui/MessageOptions;->setLockIcon(Z)V
    ...
    invoke-virtual {v11, v3, v12}, Landroid/app/Activity;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v11, v12}, Lcom/android/mms/util/DownloadManager;->Isexpired(Landroid/net/Uri;)Z
    ...
    invoke-virtual {v11, v12}, Lcom/android/mms/util/DownloadManager;->markExpriedState(Landroid/net/Uri;)V
    ...
    const-class v12, Lcom/android/mms/transaction/TransactionService;
    ...
    invoke-static {v11, v2}, Lcom/android/mms/ui/MessageUtils;->createblockNumberSettingDialog(Landroid/content/Context;Lcom/android/mms/data/Contact;)V
    ...
    iget-object v12, v0, Lcom/android/mms/ui/MessageOptions;->mActivity:Landroid/app/Activity;
    ...
    iget-wide v15, v15, Lcom/android/mms/ui/MessageItem;->mTimeMills:J

    const/16 v17, 0x1

    invoke-static/range {v14 .. v17}, Lcom/android/mms/ui/MessageUtils;->formatTimeStampString(Landroid/content/Context;JZ)Ljava/lang/String;
    ...
    new-instance v13, Lcom/android/mms/ui/MessageOptions$SendNowListener;
    ...
    invoke-direct {v13, v0, v14}, Lcom/android/mms/ui/MessageOptions$SendNowListener;-><init>(Lcom/android/mms/ui/MessageOptions;Lcom/android/mms/ui/MessageItem;)V
    ...
    iput-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mSendNowConfirmDialog:Landroid/content/DialogInterface;
    ...
    :cond_14
    new-instance v6, Lcom/android/mms/ui/MessageOptions$CancelMessageListener;

    move-object/from16 v0, p0

    invoke-direct {v6, v0, v10, v5}, Lcom/android/mms/ui/MessageOptions$CancelMessageListener;-><init>(Lcom/android/mms/ui/MessageOptions;Landroid/net/Uri;Z)V

    move-object/from16 v0, p0

    invoke-direct {v0, v6, v5}, Lcom/android/mms/ui/MessageOptions;->confirmCancelDialog(Landroid/content/DialogInterface$OnClickListener;Z)V
    ...
    iget-object v11, v0, Lcom/android/mms/ui/MessageOptions;->mAddressToCall:Ljava/lang/String;
    ...
    iget-object v12, v0, Lcom/android/mms/ui/MessageOptions;->mAddressToCall:Ljava/lang/String;

    invoke-static {v11, v12}, Lcom/android/mms/ui/MessageUtils;->makeCall(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v11, v12}, Lcom/android/mms/ui/MessageUtils;->makeVideoCall(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v11, v12}, Lcom/android/mms/ui/MessageUtils;->makePhotoringCall(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v11}, Lcom/android/mms/ui/MessageItem;->getBodyAll()Ljava/lang/String;
    ...
    invoke-static {v11, v1}, Lcom/android/mms/ui/MessageUtils;->registerToCalendar(Landroid/app/Activity;Ljava/lang/String;)V

    const-string v11, "Mms/MessageOptions"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "register calendar,len = "
    ...
    iget v12, v0, Lcom/android/mms/ui/MessageOptions;->mCurSlideLocation:I

    invoke-virtual {v11, v12}, Lcom/android/mms/ui/MessageItem;->getBodyAt(I)Ljava/lang/String;
    ...
    invoke-static {v11}, Lcom/android/mms/util/TelephonyUtils;->isEnableLinkUrlService(Lcom/android/mms/ui/MessageItem;)Z
    ...
    invoke-static {v11, v12}, Lcom/android/mms/util/TelephonyUtils;->connectSpecificTidService(Landroid/content/Context;Lcom/android/mms/ui/MessageItem;)V
