...
.field private static final READ_REPORT_PROJECTION:[Ljava/lang/String; = null
...
.field public static final mSearchBlockListener:Landroid/content/DialogInterface$OnKeyListener; = null
...
.field public static final simSize25:I = 0x2

.field public static final simSize30:I = 0x3

.field public static final simSize32:I = 0x4
...
.method public static checkRingtoneIsValid(Landroid/content/Context;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v6, "checkRingtoneIsValid : ringtoneStr = "
    ...
    const-string v6, ", isPrivateRingtone = "
    ...
    invoke-static {p0, v4}, Lcom/android/mms/ui/MessageUtils;->isValideFile(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v3}, Lcom/android/mms/ui/MessageUtils;->setDefaultSoundSetting(Landroid/content/SharedPreferences;)V
    ...
    const-string v5, "Selected ringtone is invalid"
...
.method public static createblockNumberSettingDialog(Landroid/content/Context;Lcom/android/mms/data/Contact;)V
    ...
    new-instance v7, Lcom/android/mms/ui/MessageUtils$18;

    invoke-direct {v7}, Lcom/android/mms/ui/MessageUtils$18;-><init>()V
    ...
    new-instance v6, Lcom/android/mms/ui/MessageUtils$21;

    invoke-direct {v6, p0, p1}, Lcom/android/mms/ui/MessageUtils$21;-><init>(Landroid/content/Context;Lcom/android/mms/data/Contact;)V

    invoke-virtual {v1, v5, v6}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    const v5, 0x7f0c004e

    new-instance v6, Lcom/android/mms/ui/MessageUtils$22;

    invoke-direct {v6}, Lcom/android/mms/ui/MessageUtils$22;-><init>()V
    ...
    new-instance v7, Lcom/android/mms/ui/MessageUtils$19;

    invoke-direct {v7}, Lcom/android/mms/ui/MessageUtils$19;-><init>()V
    ...
    new-instance v7, Lcom/android/mms/ui/MessageUtils$20;

    invoke-direct {v7}, Lcom/android/mms/ui/MessageUtils$20;-><init>()V
...
.method static getNumberProvinceAndCity(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v52, "number_region_activation_preference"

    const/16 v53, 0x1

    invoke-static/range {v51 .. v53}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-virtual/range {v51 .. v52}, Ljava/util/Locale;->equals(Ljava/lang/Object;)Z
    ...
    sget-object v51, Lcom/android/mms/ui/MessageUtils;->BIN_DEFAULT_DIR:Ljava/lang/String;
    ...
    invoke-virtual/range {v40 .. v40}, Ljava/io/RandomAccessFile;->getFilePointer()J

    move-result-wide v21

    sget v51, Lcom/android/mms/ui/MessageUtils;->titleSeekCount:I

    mul-int/lit8 v51, v51, 0x4
    ...
    sget v51, Lcom/android/mms/ui/MessageUtils;->provinceSize:I
    ...
    sget v52, Lcom/android/mms/ui/MessageUtils;->provinceSize:I
    ...
    sget v51, Lcom/android/mms/ui/MessageUtils;->telSize:I
    ...
    sget v52, Lcom/android/mms/ui/MessageUtils;->telSize:I
    ...
    sget-object v51, Lcom/android/mms/ui/MessageUtils;->BIN_ORIG_DEFAULT_DIR:Ljava/lang/String;
    ...
    :cond_b
    :try_start_4
    sget v51, Lcom/android/mms/ui/MessageUtils;->LANGUAGE_CHINA:I
    ...
    invoke-static/range {v51 .. v52}, Lcom/android/mms/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_e
    :try_start_6
    sget v51, Lcom/android/mms/ui/MessageUtils;->LANGUAGE_KOREA:I
    ...
    sget v51, Lcom/android/mms/ui/MessageUtils;->mobileSize:I
    ...
    sget v52, Lcom/android/mms/ui/MessageUtils;->mobileSize:I
    ...
    sget v51, Lcom/android/mms/ui/MessageUtils;->headerSize:I
    ...
    sget v52, Lcom/android/mms/ui/MessageUtils;->headerSize:I
...
.method public static getPattern()Ljava/util/regex/Pattern;
    ...
    invoke-static {}, Lcom/android/mms/ui/EmoticonList;->getEmoticonList()[[Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/mms/ui/MessageUtils;->unicodeToUTF16(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v6, v7, v8}, Ljava/lang/StringBuilder;->replace(IILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static getSmsSentTime(Landroid/content/Context;JZ)J
    ...
    const-string v4, "getSmsSentTime msgId = "
...
.method public static handleReadReport(Landroid/content/Context;JILjava/lang/Runnable;Z)V
    ...
    :cond_7
    :try_start_2
    new-instance v27, Lcom/android/mms/data/ReadReportData;
    ...
    :cond_9
    new-instance v10, Lcom/android/mms/ui/MessageUtils$5;
    ...
    invoke-direct/range {v10 .. v16}, Lcom/android/mms/ui/MessageUtils$5;-><init>(Ljava/util/Map;Landroid/content/Context;ILjava/lang/Runnable;ZLjava/util/Map;)V

    new-instance v12, Lcom/android/mms/ui/MessageUtils$6;
    ...
    invoke-direct/range {v12 .. v18}, Lcom/android/mms/ui/MessageUtils$6;-><init>(Ljava/util/Map;Ljava/util/Map;Landroid/content/Context;Ljava/util/Map;ILjava/lang/Runnable;)V

    new-instance v26, Lcom/android/mms/ui/MessageUtils$7;
    ...
    new-instance v22, Lcom/android/mms/ui/MessageUtils$8;
    ...
    invoke-static {v0, v12, v1, v2}, Lcom/android/mms/ui/MessageUtils;->confirmReadReportDialog(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public static handleReadReportOne(Landroid/content/Context;JILjava/lang/Runnable;)V
    ...
    invoke-static/range {v28 .. v28}, Lcom/android/mms/MmsConfig;->getIMSIbySimSlot(I)Ljava/lang/String;
    ...
    :cond_6
    new-instance v8, Lcom/android/mms/ui/MessageUtils$9;
    ...
    invoke-direct/range {v8 .. v13}, Lcom/android/mms/ui/MessageUtils$9;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Runnable;)V

    new-instance v12, Lcom/android/mms/ui/MessageUtils$10;
    ...
    invoke-direct/range {v12 .. v17}, Lcom/android/mms/ui/MessageUtils$10;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Runnable;)V

    new-instance v23, Lcom/android/mms/ui/MessageUtils$11;
    ...
    new-instance v20, Lcom/android/mms/ui/MessageUtils$12;
...
.method public static hasEmojiString(Ljava/lang/CharSequence;)Z
    ...
    :try_start_0
    invoke-static {}, Lcom/android/mms/MmsConfig;->getEmojiPattern()Ljava/util/regex/Pattern;
...
.method public static initSelloutSms(Landroid/content/Context;)V
    .locals 23
    ...
    sget-object v2, Lcom/android/mms/SSMSInfoProvider;->CONTENT_URI:Landroid/net/Uri;
    ...
    const-string v3, "initSelloutSms MmsConfig.getEnableSSMS()="
    ...
    const-string v2, "chmod 666 /efs/SMS/sellout_sms"
    ...
    :goto_7
    invoke-static {v1, v2, v11}, Lcom/android/mms/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v3, "initSelloutSms file Create error "
...
.method public static openModel(Landroid/content/Context;Lcom/android/mms/model/Model;)V
    ...
    instance-of v9, p1, Lcom/samsung/mms/model/LocationVcardModel;

    if-eqz v9, :cond_2

    move-object v5, p1

    check-cast v5, Lcom/samsung/mms/model/LocationVcardModel;

    const-string v9, "Mms/MessageUtils"

    const-string v10, "Launching location activity"

    invoke-static {v9, v10}, Lcom/android/mms/Log;->e(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v4, Landroid/content/Intent;

    const-class v9, Lcom/samsung/mms/location/LocationMapActivity;

    invoke-direct {v4, p0, v9}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    const-string v9, "extra_startup_flag"

    const/4 v10, 0x4

    invoke-virtual {v4, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v9, "extra_map_url"

    invoke-virtual {v5}, Lcom/samsung/mms/model/LocationVcardModel;->getUrl()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v4, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v9, "extra_selected_place"

    invoke-virtual {v5}, Lcom/samsung/mms/model/LocationVcardModel;->getPlaceBytes()[B

    move-result-object v10

    invoke-virtual {v4, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[B)Landroid/content/Intent;
    ...
    :cond_2
    instance-of v9, p1, Lcom/android/mms/model/MediaModel;
    ...
    invoke-virtual {v9}, Lcom/android/mms/drm/DrmWrapper;->getContentType()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lcom/android/mms/drm/DrmWrapper;->getDrmFilePath()Ljava/lang/String;
    ...
    const-string v10, "can\'t get model data"
    ...
    :cond_6
    instance-of v9, p1, Lcom/android/mms/model/AttachmentModel;
    ...
    invoke-static {p0, v9, v1, v7}, Lcom/android/mms/util/PackageInfo;->callGallery(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v8, v1, v7}, Lcom/android/mms/util/PackageInfo;->callVideoPlayer(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v8, v1, v7}, Lcom/android/mms/util/PackageInfo;->openVContact(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v8, v1, v7}, Lcom/android/mms/util/PackageInfo;->callCalendarImport(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v8, v1, v7}, Lcom/android/mms/util/PackageInfo;->callTaskImport(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    :cond_d
    invoke-static {p0, v8, v1, v7}, Lcom/android/mms/util/PackageInfo;->callProperActivity(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static setDefaultSoundSetting(Landroid/content/SharedPreferences;)V
    .locals 3
