...
.method public constructor <init>(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;Landroid/content/Context;II)V
    ...
    iput-boolean v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->debug:Z

    iput-object v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mAlphabetArray:[Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mDotRepresentations:Ljava/util/HashMap;
    ...
    iput v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mIndexScrollViewTheme:I

    iput-object v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mBgDrawableDefault:Landroid/graphics/drawable/Drawable;

    iput-object v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mBgDrawablePressed:Landroid/graphics/drawable/Drawable;

    const v0, 0x3a83126f

    iput v0, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->FLOAT_DIV_MULT_ERROR:F

    iput v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mSeparatorLeftPos:I
    ...
    iput v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mDepth:I
...
.method private drawAlphabetCharacters(Landroid/graphics/Canvas;)V
    ...
    iget-object v7, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mTextBounds:Landroid/graphics/Rect;
...
.method private initAlphabetArrayWithDotsIfRequired()V
    ...
    invoke-direct {v0, v1, v10}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->perfectDotsSpreadingExists(II)Z
    ...
    invoke-direct {v0, v10, v1, v2}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->calculateShift(III)I
    ...
    invoke-direct {v0, v11, v10}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->perfectDotsSpreadingExists(II)Z
...
.method private isInSelectedIndexRect(I)Z
    ...
    iget v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mAlphabetToDrawSize:I
...
.method public getIndexByPosition(II)Ljava/lang/String;
    ...
    :cond_1
    iget-boolean v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->m_bIsAlphabetInit:Z
    ...
    :cond_2
    iget v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mPosition:I
    ...
    iget v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mDepth:I
    ...
    invoke-direct {p0, v2}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->isSelectedIndexDot(I)Z

    move-result v2

    if-nez v2, :cond_6

    iget-object v2, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mAlphabetArrayToDraw:[Ljava/lang/String;
    ...
    :cond_8
    iget-boolean v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->m_bSubIndexScrollExists:Z

    if-nez v3, :cond_d

    iget v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mDepth:I

    iget v4, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mMaxDepth:I
    ...
    iget v4, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mItemWidth:I

    add-int/2addr v3, v4

    iget v4, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mItemWidthGap:I
    ...
    iget v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mWidth:I
    ...
    :goto_1
    iget-object v3, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mSubIndexScroll:Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;

    invoke-virtual {v3, p1, p2}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->getIndexByPosition(II)Ljava/lang/String;
...
.method public getSelectedIndex()I
    ...
    iget-boolean v0, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->m_bAlphabetArrayWithDotsUsed:Z
    ...
    iget v0, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mOrigSelectedDotIndex:I
...
.method public setIndexScrollViewTheme(I)V
    ...
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$200(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)Z
    ...
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$300(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$400(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$500(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)I
    ...
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$600(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)I
    ...
    #getter for: Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->mCstmHandleTextColorPressed:I
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$700(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)I
    ...
    invoke-static {v1}, Lcom/sec/android/touchwiz/widget/TwIndexScrollView;->access$800(Lcom/sec/android/touchwiz/widget/TwIndexScrollView;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_a
    iget v1, p0, Lcom/sec/android/touchwiz/widget/TwIndexScrollView$IndexScroll;->mHandleTextColorPressed:I
